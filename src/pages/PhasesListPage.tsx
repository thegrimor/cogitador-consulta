    ...
    >
      <div>
        <div className="flex items-center gap-2">
          <span className="text-[8px] font-mono uppercase tracking-widest text-crimson">{refNum}</span>
      ...
      {PHASE_GROUPS.map((group: PhaseGroup) => {
        ...
        return (
          <div key={group} className="mb-8">
            <h2 className="text-[9px] font-display uppercase tracking-[2px] text-parchment-dim mb-2 px-1">
              {group}
            </h2>
