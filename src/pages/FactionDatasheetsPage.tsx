          ...
          {filtered.map(ds => {
            ...
            return (
              <NavLink
                ...
                className="group flex items-center justify-between gap-3 bg-surface-2 border border-rim-bright hover:border-crimson-bright px-3 py-2.5 transition-colors"
              >
