    ...
    <div className="border border-rim-bright">
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-[8px] font-mono uppercase tracking-widest text-crimson shrink-0">{refNum}</span>
          <span className="text-[10px] font-display uppercase tracking-widest text-parchment">
            {name}
          </span>
        </div>
        <span className="text-[12px] font-mono text-parchment-dim ml-2 shrink-0 transition-transform" style={{ transform: open ? 'rotate(90deg)' : 'rotate(0deg)' }}>
          ›
        </span>
      </button>
      {open && (
        <div className="px-4 py-3 border-t border-rim-bright bg-surface-1">
          <p className="text-[9px] font-mono text-parchment-dim leading-relaxed whitespace-pre-line">
            {description}
          </p>
        </div>
      )}
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3">
          <span className="text-[10px] font-mono uppercase tracking-widest text-crimson">{phase.ref}</span>
