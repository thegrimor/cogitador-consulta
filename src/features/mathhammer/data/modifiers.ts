...
const RULES_1: ModifierRule[] = [
  ...
  // ═══ AE ═══
  { id: 'ae_blades_from_beyond', label: 'Blades from Beyond — Devastating Wounds, CaC (1PC)', description: 'Spirit Conclave: TARGET: One Wraithblades, Wraithlord or Wraithknight unit from your army that has not been selected to fight this phase. EFFECT: Until the end of the phase, melee weapons equipped by models in your unit have the [DEVASTATING WOUNDS] ability.', factionId: 'AE', detachmentId: '000001019', combatType: 'melee', isStratagem: true, cpCost: 1, effects: { devastatingWoundsBonus: true } },
  {
  ...
  { id: 'aoi_ignis_judicium', label: 'Ignis Judicium — Devastating Wounds, Melta 1, Precision (disparo)', description: 'Ignis Judicium: Inquisitor or Ministorum Priest model only. The bearer’s ranged weapons have the [DEVASTATING WOUNDS], [MELTA 1] and [PRECISION] abilities.', factionId: 'AoI', detachmentId: '000000893', combatType: 'ranged', effects: { devastatingWoundsBonus: true } },
  {
  ...
  // Nota: "Black Crusade" (000008961005, Devious Stratagems, 1PC) también otorga Devastating Wounds
  // a boltguns tras advance/fall back, pero la condición es demasiado específica para modelar con
  // los campos disponibles hoy — se omite deliberadamente.
  { id: 'csm_fleeting_might', label: 'Fleeting Might — Devastating Wounds (post-Dark Pact)', description: 'Underdeck Uprising: just after a DAMNED unit from your army makes a Dark Pact, until the end of the phase, weapons equipped by models in your unit have the [DEVASTATING WOUNDS] ability.', factionId: 'CSM', detachmentId: '000000947', isStratagem: true, cpCost: 1, effects: { devastatingWoundsBonus: true } },
  {
  ...
  // ═══ DRU ═══
  { id: 'dru_distillers_of_fear', label: 'Distillers of Fear — Devastating Wounds vs Battle-shocked (CaC, 2PC)', description: 'Covenite Coterie: select one Haemonculus Covens unit that has not been selected to fight this phase. Until the end of the phase, each attack from your unit that targets a Battle-shocked enemy unit has [DEVASTATING WOUNDS].', factionId: 'DRU', detachmentId: '000001114', combatType: 'melee', isStratagem: true, cpCost: 2, effects: { devastatingWoundsBonus: true } },
  { id: 'dru_salting_the_wound', label: 'Salting the Wound — Devastating Wounds vs Battle-shocked (CaC, 1PC)', description: 'Tools of Torment: when a friendly CRONOS/TALOS unit is selected to fight, until the end of the phase your unit’s attacks that target a Battle-shocked unit have [DEVASTATING WOUNDS].', factionId: 'DRU', detachmentId: '000001195', combatType: 'melee', isStratagem: true, cpCost: 1, effects: { devastatingWoundsBonus: true } },
...
const RULES_2: ModifierRule[] = [
  ...
  // ═══ GK ═══
  { id: 'gk_truesilver_channelling', label: 'Truesilver Channelling — Devastating Wounds, Psychic (CaC, 2PC)', description: 'Brotherhood Strike: select one Grey Knights Infantry unit that has not been selected to fight this phase. Until the end of the phase, Psychic weapons equipped by models in your unit have the [DEVASTATING WOUNDS] ability.', factionId: 'GK', detachmentId: '000001081', combatType: 'melee', isStratagem: true, cpCost: 2, effects: { devastatingWoundsBonus: true } },
  { id: 'gk_focused_immolation', label: 'Focused Immolation — Devastating Wounds, Sustained Hits 1, disparo (1PC)', description: 'Fires of Purgation: when a friendly PURGATION SQUAD unit is selected to shoot, select one enemy unit. Your unit’s ranged attacks that target that unit have [DEVASTATING WOUNDS] and [SUSTAINED HITS 1].', factionId: 'GK', detachmentId: '000001186', combatType: 'ranged', isStratagem: true, cpCost: 1, effects: { devastatingWoundsBonus: true, sustainedHitsBonus: 1 } },
  {
  ...
  { id: 'lov_masterful_construction_dw', label: 'Masterful Construction — Devastating Wounds', description: "Masterful Construction: each time the bearer is selected to shoot or fight, you can select one of [DEVASTATING WOUNDS]/[LETHAL HITS]/[SUSTAINED HITS 1] for the bearer's weapons (excluding Psychic weapons) until the end of the phase.", factionId: 'LoV', detachmentId: '000000950', effects: { devastatingWoundsBonus: true } },
  ...
  { id: 'sm_immolation_protocols_1086', label: 'Immolation Protocols — Devastating Wounds, Torrent, disparo (2PC)', description: 'Forgefather’s Seekers: select one ADEPTUS ASTARTES unit that has not been selected to shoot this phase. Until the end of the phase, Torrent weapons equipped by models in your unit have the [DEVASTATING WOUNDS] ability.', factionId: 'SM', detachmentId: '000001086', combatType: 'ranged', isStratagem: true, cpCost: 2, effects: { devastatingWoundsBonus: true } },
...
const RULES_3: ModifierRule[] = [
  ...
  // de ejército real es Blessings of Khorne (abajo).
  ...
  { id: 'we_blessings_decapitating_strikes', label: 'Blessings of Khorne: Decapitating Strikes — Devastating Wounds vs INFANTRY (CaC)', description: "DECAPITATING STRIKES: each time a model in this unit makes a melee attack that targets an INFANTRY unit, that attack has the [DEVASTATING WOUNDS] ability.", factionId: 'WE', combatType: 'melee', requiresTargetKeyword: 'infantry', effects: { devastatingWoundsBonus: true } },
  {
  ...
  { id: 'opb_000003714_canoness_jp', label: '[OPB] Canoness con Jump Pack — +3 ataques, Devastating Wounds CaC', factionId: 'AS', leaderDatasheetId: '000003714', combatType: 'melee', effects: { attacksMod: 3, devastatingWoundsBonus: true } },
  { id: 'opb_000003811_aveline', label: '[OPB] Celestian Sacresant Aveline — +3 ataques, Devastating Wounds CaC', factionId: 'AS', leaderDatasheetId: '000003811', combatType: 'melee', effects: { attacksMod: 3, devastatingWoundsBonus: true } },
  ...
  { id: 'opb_000003831_ba_captain', label: '[OPB] Blood Angels Captain — +3 ataques, Devastating Wounds CaC', factionId: 'SM', leaderDatasheetId: '000003831', combatType: 'melee', effects: { attacksMod: 3, devastatingWoundsBonus: true } },
  { id: 'opb_000000073_captain', label: '[OPB] Captain — +3 ataques, Devastating Wounds CaC', factionId: 'SM', leaderDatasheetId: '000000073', combatType: 'melee', effects: { attacksMod: 3, devastatingWoundsBonus: true } },
  ...
  { id: 'opb_000002795_ec_champion', label: "[OPB] Emperor's Champion — Devastating Wounds CaC", factionId: 'SM', leaderDatasheetId: '000002795', combatType: 'melee', effects: { devastatingWoundsBonus: true } },
  ...
  { id: 'opb_000004103_slaughterbound', label: '[OPB] Slaughterbound — +3 ataques, Devastating Wounds CaC', factionId: 'WE', leaderDatasheetId: '000004103', combatType: 'melee', effects: { attacksMod: 3, devastatingWoundsBonus: true } },
...
const RULES_5: ModifierRule[] = [
  ...
  // ── Gap audit additions (combat-relevant abilities found missing from coverage) ──
  // ── AC ──
  {
    id: 'gap_ac_auramite_and_adamantine',
    label: 'Shield-captain In Allarus Terminator Armour — Damage a 1 (Defensor)',
    ...
    factionId: 'AC',
    datasheetId: '000001448',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── AE ──
  {
    id: 'gap_ae_cry_of_the_wind',
    label: 'Baharroth — crítico 2+ disparo',
    ...
    factionId: 'AE',
    datasheetId: '000000575',
    combatType: 'ranged',
    effects: { critThreshold: 2 },
  },
  {
    id: 'gap_ae_crystal_matrix',
    label: 'Fire Prism — repetir impactos y heridas, disparo',
    ...
    factionId: 'AE',
    datasheetId: '000000610',
    combatType: 'ranged',
    effects: { rerollAllHits: true, rerollAllWounds: true },
  },
  {
    id: 'gap_ae_inescapable_accuracy',
    label: 'Dark Reapers — +1 impactar, disparo',
    ...
    factionId: 'AE',
    datasheetId: '000000607',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_ae_psychic_communion_000000585',
    label: 'Warlock — +1 Fuerza/+1 Ataque (Psychic Communion)',
    ...
    factionId: 'AE',
    datasheetId: '000000585',
    combatType: 'ranged',
    effects: { attacksMod: 1, strengthMod: 1 },
  },
  {
    id: 'gap_ae_psychic_communion_000000587',
    label: 'Warlock Skyrunners — +1 Fuerza/+1 Ataque (Psychic Communion)',
    description: 'Each time this unit is selected to shoot, for each Warlock model in this unit, until the end of the phase, add 1 to the Attacks and Strength characteristics of that model’s Destructor weapon for each other friendly Aeldari Psyker model within 6" of that model (to a maximum of +2).',
    factionId: 'AE',
    datasheetId: '000000587',
    combatType: 'ranged',
    effects: { attacksMod: 1, strengthMod: 1 },
  },
  {
    id: 'gap_ae_scattershield_000000614',
    label: 'Wraithknight — FNP 4+ y -1 Daño (Scattershield)',
    ...
    factionId: 'AE',
    datasheetId: '000000614',
    target: 'defender',
    effects: { feelNoPainThreshold: 4, damageReduction: 1 },
  },
  {
    id: 'gap_ae_scattershield_000003913',
    label: 'Wraithknight with Ghostglaive — FNP 4+ y -1 Daño (Scattershield)',
    description: 'The bearer has a 4+ invulnerable save and each time an attack is allocated to the bearer, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'AE',
    datasheetId: '000003913',
    target: 'defender',
    effects: { feelNoPainThreshold: 4, damageReduction: 1 },
  },
  {
    id: 'gap_ae_scattershield_000000627',
    label: 'Skathach Wraithknight — FNP 4+ (Scattershield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'AE',
    datasheetId: '000000627',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_ae_serpent_shield',
    label: 'Storm Guardians — FNP 5+ (Serpent Shield)',
    description: 'Models in the bearer’s unit have a 5+ invulnerable save.',
    factionId: 'AE',
    datasheetId: '000000590',
    target: 'defender',
    effects: { feelNoPainThreshold: 5 },
  },
  {
    id: 'gap_ae_shimmershield',
    label: 'Shining Spears — FNP 4+ (Shimmershield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'AE',
    datasheetId: '000000602',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_ae_sonic_destruction',
    label: 'Vibro Cannon Platform — +1 F/PA/Daño (Sonic Destruction)',
    description: 'In your Shooting phase, each time this model makes an attack with its vibro cannon that targets an enemy unit, improve the Strength, Armour Penetration and Damage characteristics of that attack by 1 for each other friendly VIBRO CANNON PLATFORM model that made one or more attacks with its vibro cannon this phase.',
    factionId: 'AE',
    datasheetId: '000003912',
    combatType: 'ranged',
    effects: { strengthMod: 1, apMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_ae_structural_collapse',
    label: 'D-cannon Platform — repetir Daño 1, disparo',
    ...
    factionId: 'AE',
    datasheetId: '000003910',
    combatType: 'ranged',
    effects: { rerollDamageOf1: true },
  },
  {
    id: 'gap_ae_titan_hunter',
    label: 'Vampire Hunter — repetir Daño 1, disparo',
    ...
    factionId: 'AE',
    datasheetId: '000000626',
    combatType: 'ranged',
    effects: { rerollDamageOf1: true },
  },
  // ── AM ──
  {
    id: 'gap_am_anti_armour_gunship',
    label: 'Vendetta Gunship — repetir Daño 1, disparo',
    description: 'Each time a ranged attack made by this model is allocated to a MONSTER or VEHICLE model, re-roll a Damage roll of 1.',
    factionId: 'AM',
    datasheetId: '000000783',
    combatType: 'ranged',
    effects: { rerollDamageOf1: true },
  },
  {
    id: 'gap_am_brute_shield',
    label: 'Bullgryn Squad — FNP 4+ (Brute Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'AM',
    datasheetId: '000000723',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_am_leading_the_charge',
    label: 'Lord Marshal Dreir — Devastating Wounds CaC (carga)',
    ...
    factionId: 'AM',
    datasheetId: '000003890',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_am_ratling_battlemutt',
    label: 'Ratlings — Lethal Hits disparo (Ratling Battlemutt)',
    ...
    factionId: 'AM',
    datasheetId: '000000724',
    combatType: 'ranged',
    effects: { lethalHitsBonus: true },
  },
  // ── AM/CD/CSM/QT — Wall of Muscle ──
  {
    id: 'gap_wall_of_muscle_000000723',
    label: 'Bullgryn Squad — -1 Daño recibido (Wall of Muscle)',
  ...
  {
    id: 'gap_wall_of_muscle_000002735',
    label: 'Renegade Plague Ogryns — -1 Daño recibido (Wall of Muscle)',
    description: 'Each time an attack is allocated to a model in this unit, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'CSM',
    datasheetId: '000002735',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_wall_of_muscle_000003860',
    label: 'Renegade Plague Ogryns — -1 Daño recibido (Wall of Muscle)',
    description: 'Each time an attack is allocated to a model in this unit, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'QT',
    datasheetId: '000003860',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_wall_of_muscle_000004061',
    label: 'Renegade Plague Ogryns — -1 Daño recibido (Wall of Muscle)',
    description: 'Each time an attack is allocated to a model in this unit, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'CD',
    datasheetId: '000004061',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── AM/GC ──
  {
    id: 'gap_am_gc_alchemyk_counteragents_000003889',
    label: 'Krieg Command Squad — FNP 6+ vs mortales (Alchemyk Counteragents)',
    description: 'The bearer’s unit has the Feel No Pain 6+ ability against mortal wounds.',
    factionId: 'AM',
    datasheetId: '000003889',
    target: 'defender',
    effects: { feelNoPainThreshold: 6 },
  },
  {
    id: 'gap_am_gc_alchemyk_counteragents_000003941',
    label: 'Krieg Command Squad — FNP 6+ vs mortales (Alchemyk Counteragents)',
    description: 'The bearer’s unit has the Feel No Pain 6+ ability against mortal wounds.',
    factionId: 'GC',
    datasheetId: '000003941',
    target: 'defender',
    effects: { feelNoPainThreshold: 6 },
  },
  {
    id: 'gap_am_gc_armoured_aggressor_000000772',
    label: 'Macharius Vulcan — +1 impactar disparo (Armoured Aggressor)',
    ...
    factionId: 'AM',
    datasheetId: '000000772',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_am_gc_armoured_aggressor_000004014',
    label: 'Macharius Vulcan — +1 impactar disparo (Armoured Aggressor)',
    description: 'Each time this model makes a ranged attack, it does not suffer the penalty to the Hit roll for being within Engagement Range of one or more enemy units.',
    factionId: 'GC',
    datasheetId: '000004014',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_am_gc_armoured_frontis_000000775',
    label: 'Minotaur — -1 Daño recibido (Armoured Frontis)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'AM',
    datasheetId: '000000775',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_am_gc_armoured_frontis_000004020',
    label: 'Minotaur — -1 Daño recibido (Armoured Frontis)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'GC',
    datasheetId: '000004020',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_am_gc_called_shots_000003892',
    label: 'Rogal Dorn Commander — repetir impacto/herida/daño (Called Shots)',
    ...
    factionId: 'AM',
    datasheetId: '000003892',
    combatType: 'ranged',
    effects: { rerollAllHits: true, rerollAllWounds: true, rerollAllDamage: true },
  },
  {
    id: 'gap_am_gc_called_shots_000003944',
    label: 'Rogal Dorn Commander — repetir impacto/herida/daño (Called Shots)',
    description: 'Each time this model is selected to shoot, you can re-roll one Hit roll, you can re-roll one Wound roll and you can re-roll one Damage roll when resolving its attacks.',
    factionId: 'GC',
    datasheetId: '000003944',
    combatType: 'ranged',
    effects: { rerollAllHits: true, rerollAllWounds: true, rerollAllDamage: true },
  },
  {
    id: 'gap_am_gc_close_quarters_warfare_000000706',
    label: 'Hellhammer — +1 impactar disparo (Close-quarters Warfare)',
    ...
    factionId: 'AM',
    datasheetId: '000000706',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_am_gc_close_quarters_warfare_000003973',
    label: 'Hellhammer — +1 impactar disparo (Close-quarters Warfare)',
    description: 'This model does not suffer the penalty to its Hit rolls for making ranged attacks while enemy units are within Engagement Range of it.',
    factionId: 'GC',
    datasheetId: '000003973',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_am_gc_line_breaker_000000701',
    label: 'Leman Russ Demolisher — +1 impactar disparo (Line-breaker)',
    description: 'When making ranged attacks with its demolisher battle cannon, this model can target enemy units within Engagement Range of it. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'AM',
    datasheetId: '000000701',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_am_gc_line_breaker_000003980',
    label: 'Leman Russ Demolisher — +1 impactar disparo (Line-breaker)',
    description: 'When making ranged attacks with its demolisher battle cannon, this model can target enemy units within Engagement Range of it. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'GC',
    datasheetId: '000003980',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_am_gc_mow_down_the_enemy_000002744',
    label: 'Leman Russ Punisher — Devastating Wounds disparo (Mow Down the Enemy)',
    ...
    factionId: 'AM',
    datasheetId: '000002744',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_am_gc_mow_down_the_enemy_000003984',
    label: 'Leman Russ Punisher — Devastating Wounds disparo (Mow Down the Enemy)',
    description: 'Each time this model makes an attack with its punisher gatling cannon that targets an enemy unit (excluding MONSTERS and VEHICLES), that attack has the [DEVASTATING WOUNDS] ability.',
    factionId: 'GC',
    datasheetId: '000003984',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_am_gc_power_overload_000000777',
    label: 'Valdor — repetir Daño, disparo vs Monstruo/Vehículo (Power Overload)',
    description: 'Each time this model makes an attack that targets a MONSTER or VEHICLE unit, you can re-roll the Damage roll.',
    factionId: 'AM',
    datasheetId: '000000777',
    combatType: 'ranged',
    effects: { rerollAllDamage: true },
  },
  {
    id: 'gap_am_gc_power_overload_000004035',
    label: 'Valdor — repetir Daño, disparo vs Monstruo/Vehículo (Power Overload)',
    description: 'Each time this model makes an attack that targets a MONSTER or VEHICLE unit, you can re-roll the Damage roll.',
    factionId: 'GC',
    datasheetId: '000004035',
    combatType: 'ranged',
    effects: { rerollAllDamage: true },
  },
  {
    id: 'gap_am_gc_urban_warfare_000002741',
    label: 'Leman Russ Eradicator — -1 Daño recibido con Cobertura (Urban Warfare)',
    ...
    factionId: 'AM',
    datasheetId: '000002741',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_am_gc_urban_warfare_000003981',
    label: 'Leman Russ Eradicator — -1 Daño recibido con Cobertura (Urban Warfare)',
    description: 'Each time a ranged attack targets this model, if this model has the Benefit of Cover against that attack, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'GC',
    datasheetId: '000003981',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── AM/GC — FORTIFICATION (-1 impactar, asediada) ──
  {
    id: 'gap_am_gc_fortification_000002739',
    label: 'Earthshaker Platform — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'AM',
    datasheetId: '000002739',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_am_gc_fortification_000003956',
    label: 'Earthshaker Platform — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'GC',
    datasheetId: '000003956',
    effects: { hitMod: -1 },
  },
  // ── AS ──
  {
    id: 'gap_as_auto_tapestry',
    label: 'Aestred Thurga And Agathae Dolan — Devastating Wounds (Líder)',
    ...
    factionId: 'AS',
    leaderDatasheetId: '000002480',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_as_death_cult',
    label: 'Death Cult Assassins — repetir herida vs Character',
    description: 'Each time a model in this unit makes an attack that targets a CHARACTER unit, re-roll a Wound roll.',
    factionId: 'AS',
    datasheetId: '000000895',
    combatType: 'melee',
    requiresTargetKeyword: 'CHARACTER',
    effects: { rerollAllWounds: true },
  },
  {
    id: 'gap_as_fortification',
    label: 'Battle Sanctum — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'AS',
    datasheetId: '000002068',
    effects: { hitMod: -1 },
  },
  // ── AoI ──
  {
    id: 'gap_aoi_blessed_wardings_000000877',
    label: 'Inquisitor — FNP 6+ (Líder, Blessed Wardings)',
    description: 'While this model is leading a unit, models in that unit have the 6+ invulnerable save.',
    factionId: 'AoI',
    leaderDatasheetId: '000000877',
    target: 'defender',
    effects: { feelNoPainThreshold: 6 },
  },
  {
    id: 'gap_aoi_blessed_wardings_000002760',
    label: 'Inquisitor In Terminator Armour — FNP 6+ (Líder, Blessed Wardings)',
    description: 'While the bearer is leading a unit, models in that unit have a 6+ invulnerable save.',
    factionId: 'AoI',
    leaderDatasheetId: '000002760',
    target: 'defender',
    effects: { feelNoPainThreshold: 6 },
  },
  // ── AoI/SM ──
  {
    id: 'gap_aoi_sm_astartes_shield_000000064',
    label: 'Assault Squad with Jump Packs — FNP 4+ (Astartes Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000000064',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_aoi_sm_astartes_shield_000002103',
    label: 'Command Squad — FNP 4+ (Astartes Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000002103',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_aoi_sm_astartes_shield_000003823',
    label: 'Veteran Bike Squad — FNP 4+ (Astartes Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'AoI',
    datasheetId: '000003823',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_aoi_sm_catechism_of_death_000003821',
    label: 'Kill Team Cassius — Devastating Wounds CaC (Catechism of Death)',
    ...
    factionId: 'AoI',
    datasheetId: '000003821',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_aoi_sm_catechism_of_death_000003875',
    label: 'Kill Team Cassius — Devastating Wounds CaC (Catechism of Death)',
    description: 'While this unit contains Chaplain Cassius, melee weapons equipped by models in this unit have the [DEVASTATING WOUNDS] ability.',
    factionId: 'SM',
    datasheetId: '000003875',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_aoi_sm_helix_gauntlet_000000128',
    label: 'Infiltrator Squad — FNP 6+ (Helix Gauntlet)',
    description: 'Models in the bearer’s unit have the Feel No Pain 6+ ability.',
    factionId: 'SM',
    datasheetId: '000000128',
    target: 'defender',
    effects: { feelNoPainThreshold: 6 },
  },
  {
    id: 'gap_aoi_sm_helix_gauntlet_000002779',
    label: 'Spectrus Kill Team — FNP 6+ (Helix Gauntlet)',
    description: 'Models in the bearer’s unit have the Feel No Pain 6+ ability.',
    factionId: 'SM',
    datasheetId: '000002779',
    target: 'defender',
    effects: { feelNoPainThreshold: 6 },
  },
  {
    id: 'gap_aoi_sm_helix_gauntlet_000003827',
    label: 'Spectrus Kill Team — FNP 6+ (Helix Gauntlet)',
    description: 'Models in the bearer’s unit have the Feel No Pain 6+ ability.',
    factionId: 'AoI',
  ...
  {
    id: 'gap_aoi_sm_psychic_hood',
    label: 'Kill Team Cassius — FNP 4+ vs Psíquicos (Psychic Hood)',
  ...
  // ── CD ──
  {
    id: 'gap_csm_chance_for_glory',
    label: 'Chaos Lord — +1 F/A/PA/Daño CaC (Chance for Glory)',
    ...
    factionId: 'CSM',
    datasheetId: '000000929',
    combatType: 'melee',
    effects: { strengthMod: 1, attacksMod: 1, apMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_cd_chance_for_glory_000004036',
    label: 'Chaos Lord — +1 F/A/PA/Daño CaC (Chance for Glory)',
    description: 'Once per battle, at the start of the Fight phase, this model can use this ability. If it does, until the end of the phase, improve the Strength, Attacks, Armour Penetration and Damage characteristics of melee weapons equipped by this model by 1.',
    factionId: 'CD',
    datasheetId: '000004036',
    combatType: 'melee',
    effects: { strengthMod: 1, attacksMod: 1, apMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_csm_stabilisation_talons',
    label: 'Havocs — +1 impactar disparo (Stabilisation Talons)',
    ...
    factionId: 'CSM',
    datasheetId: '000000966',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_cd_stabilisation_talons_000004063',
    label: 'Havocs — +1 impactar disparo (Stabilisation Talons)',
    description: 'Each time a model in this unit makes an attack with a ranged weapon, you can ignore any or all modifiers to the Hit roll and any or all modifiers to the Ballistic Skill characteristic of that weapon.',
    factionId: 'CD',
    datasheetId: '000004063',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_csm_unholy_bloodshed',
    label: 'Possessed — Devastating Wounds (Dark Pact, Unholy Bloodshed)',
    ...
    factionId: 'CSM',
    datasheetId: '000000953',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_cd_unholy_bloodshed_000004066',
    label: 'Possessed — Devastating Wounds (Dark Pact, Unholy Bloodshed)',
    description: 'Once per battle, when this unit makes a Dark Pact, until the end of the phase, weapons equipped by models in this unit have the [DEVASTATING WOUNDS] ability.',
    factionId: 'CD',
    datasheetId: '000004066',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_cd_collar_of_khorne',
    label: 'Flesh Hounds — FNP 3+ vs Psíquicos (Collar of Khorne)',
    description: 'The bearer has the Feel No Pain 3+ ability against Psychic Attacks.',
    factionId: 'CD',
    datasheetId: '000001112',
    target: 'defender',
    effects: { feelNoPainThreshold: 3 },
  },
  {
    id: 'gap_we_collar_of_khorne_000004108',
    label: 'Flesh Hounds — FNP 3+ vs Psíquicos (Collar of Khorne)',
    description: 'The bearer has the Feel No Pain 3+ ability against Psychic Attacks.',
    factionId: 'WE',
  ...
  {
    id: 'gap_cd_skullmasters_fury',
    label: 'Skullmaster — Devastating Wounds CaC (Líder, carga)',
    ...
    factionId: 'CD',
    leaderDatasheetId: '000001456',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_cd_creature_of_khorne_000001338',
    label: 'Spined Chaos Beast — +2 Fuerza CaC (marca de Khorne)',
    description: 'If this model has the KHORNE keyword, add 2 to the Strength characteristic of this model’s melee weapons.',
    factionId: 'CD',
    datasheetId: '000001338',
    combatType: 'melee',
    effects: { strengthMod: 2 },
  },
  {
    id: 'gap_cd_creature_of_khorne_000001339',
    label: 'Giant Chaos Spawn — +2 Fuerza CaC (marca de Khorne)',
    description: 'If this model has the KHORNE keyword, add 2 to the Strength characteristic of this model’s melee weapons.',
    factionId: 'CD',
    datasheetId: '000001339',
    combatType: 'melee',
    effects: { strengthMod: 2 },
  },
  {
    id: 'gap_cd_creature_of_tzeentch_000001338',
    label: 'Spined Chaos Beast — FNP 4+ (marca de Tzeentch)',
  ...
  {
    id: 'gap_cd_creature_of_tzeentch_000001339',
    label: 'Giant Chaos Spawn — FNP 4+ (marca de Tzeentch)',
    description: 'If this model has the TZEENTCH keyword, this model has a 4+ invulnerable save.',
    factionId: 'CD',
    datasheetId: '000001339',
    target: 'defender',
  ...
  // ── CSM ──
  {
    id: 'gap_csm_ascended_daemon',
    label: 'Heretic Astartes Daemon Prince — repetir impacto/herida',
    ...
    factionId: 'CSM',
    datasheetId: '000000937',
    effects: { rerollAllHits: true, rerollAllWounds: true },
  },
  {
    id: 'gap_csm_daemonic_ordnance',
    label: 'Forgefiend — Devastating Wounds disparo (Daemonic Ordnance)',
    ...
    factionId: 'CSM',
    datasheetId: '000000967',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_csm_khorne',
    label: 'Heretic Astartes Daemon Prince — +2 Fuerza CaC (Khorne)',
    description: 'Add 2 to the Strength characteristic of this model\'s hellforged weapons.',
    factionId: 'CSM',
    datasheetId: '000000937',
    combatType: 'melee',
    effects: { strengthMod: 2 },
  ...
  {
    id: 'gap_csm_khorne_000002730',
    label: 'Heretic Astartes Daemon Prince With Wings — +2 Fuerza CaC (Khorne)',
    description: 'Add 2 to the Strength characteristic of this model\'s hellforged weapons.',
    factionId: 'CSM',
    datasheetId: '000002730',
    combatType: 'melee',
    effects: { strengthMod: 2 },
  },
  {
    id: 'gap_csm_outmanoeuvre',
    label: 'Chaos Bikers — +1 Fuerza CaC (carga)',
    ...
    factionId: 'CSM',
    datasheetId: '000000957',
    combatType: 'melee',
    effects: { strengthMod: 1 },
  },
  {
    id: 'gap_csm_tzeentch',
    label: 'Heretic Astartes Daemon Prince — +3 Ataques disparo (Tzeentch)',
    description: 'Add 3 to the Attacks characteristic of its infernal cannon.',
    factionId: 'CSM',
    datasheetId: '000000937',
    combatType: 'ranged',
    effects: { attacksMod: 3 },
  },
  {
    id: 'gap_csm_tzeentch_000002730',
    label: 'Heretic Astartes Daemon Prince With Wings — +3 Ataques disparo (Tzeentch)',
    description: 'Add 3 to the Attacks characteristic of its infernal cannon.',
    factionId: 'CSM',
    datasheetId: '000002730',
    combatType: 'ranged',
  ...
  // ── CSM/DG/GK/SM/TS/WE — Armoured Resilience ──
  {
    id: 'gap_armoured_resilience_000000113',
    label: 'Storm Eagle Gunship — -1 Daño recibido (Armoured Resilience)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'SM',
    datasheetId: '000000113',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_armoured_resilience_000000398',
    label: 'Stormraven Gunship — -1 Daño recibido (Armoured Resilience)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'GK',
    datasheetId: '000000398',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_armoured_resilience_000001191',
    label: 'Stormraven Gunship — -1 Daño recibido (Armoured Resilience)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'SM',
  ...
  {
    id: 'gap_armoured_resilience_000003671',
    label: 'Storm Eagle Gunship — -1 Daño recibido (Armoured Resilience)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'TS',
    datasheetId: '000003671',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_armoured_resilience_000003672',
    label: 'Storm Eagle Gunship — -1 Daño recibido (Armoured Resilience)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'DG',
    datasheetId: '000003672',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_armoured_resilience_000003673',
    label: 'Storm Eagle Gunship — -1 Daño recibido (Armoured Resilience)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'WE',
    datasheetId: '000003673',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── CSM/DG/QI/QT/SM/TS/WE — Conversion ──
  {
    id: 'gap_conversion_000001295',
    label: 'Decimator — crítico 4+ a >12" (Conversion)',
    ...
    factionId: 'CSM',
    datasheetId: '000001295',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000001302',
    label: 'Chaos Deimos Predator — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'CSM',
    datasheetId: '000001302',
    combatType: 'ranged',
  ...
  {
    id: 'gap_conversion_000001527',
    label: 'Techmarine on Bike — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'SM',
    datasheetId: '000001527',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000001663',
    label: 'War Dog Moirax — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'QT',
    datasheetId: '000001663',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000002268',
    label: 'Deimos Predator — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'SM',
    datasheetId: '000002268',
    combatType: 'ranged',
  ...
  {
    id: 'gap_conversion_000002719',
    label: 'Relic Contemptor Dreadnought — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'SM',
    datasheetId: '000002719',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000002769',
    label: 'Armiger Moirax — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'QI',
    datasheetId: '000002769',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000003655',
    label: 'Relic Contemptor Dreadnought — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'TS',
    datasheetId: '000003655',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000003656',
    label: 'Relic Contemptor Dreadnought — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'DG',
    datasheetId: '000003656',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000003657',
    label: 'Relic Contemptor Dreadnought — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'WE',
    datasheetId: '000003657',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_conversion_000003658',
    label: 'Relic Contemptor Dreadnought — crítico 4+ a >12" (Conversion)',
    description: 'Each time an attack made with this weapon targets a unit more than 12" from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'CSM',
    datasheetId: '000003658',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  // ── CSM/DG/SM/TS/WE — Duty Eternal ──
  {
    id: 'gap_duty_eternal_000000131',
    label: 'Leviathan Dreadnought — -1 Daño recibido (Duty Eternal)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'SM',
    datasheetId: '000000131',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_duty_eternal_000002717',
    label: 'Redemptor Dreadnought — -1 Daño recibido (Duty Eternal)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'SM',
  ...
  {
    id: 'gap_duty_eternal_000003647',
    label: 'Leviathan Dreadnought — -1 Daño recibido (Duty Eternal)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'TS',
    datasheetId: '000003647',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_duty_eternal_000003648',
    label: 'Leviathan Dreadnought — -1 Daño recibido (Duty Eternal)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'DG',
    datasheetId: '000003648',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_duty_eternal_000003649',
    label: 'Leviathan Dreadnought — -1 Daño recibido (Duty Eternal)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'WE',
    datasheetId: '000003649',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_duty_eternal_000003650',
    label: 'Leviathan Dreadnought — -1 Daño recibido (Duty Eternal)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'CSM',
    datasheetId: '000003650',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── CSM/DG/SM/TS/WE — Inviolable Transport ──
  {
    id: 'gap_inviolable_transport_000001189',
    label: 'Mastodon — Daño a 0 (Inviolable Transport)',
    ...
    factionId: 'SM',
    datasheetId: '000001189',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_inviolable_transport_000003643',
    label: 'Mastodon — Daño a 0 (Inviolable Transport)',
    description: 'Once per battle round, when an attack is allocated to this model, you can change the Damage characteristic of that attack to 0.',
    factionId: 'TS',
    datasheetId: '000003643',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_inviolable_transport_000003644',
    label: 'Mastodon — Daño a 0 (Inviolable Transport)',
    description: 'Once per battle round, when an attack is allocated to this model, you can change the Damage characteristic of that attack to 0.',
    factionId: 'DG',
    datasheetId: '000003644',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_inviolable_transport_000003645',
    label: 'Mastodon — Daño a 0 (Inviolable Transport)',
    description: 'Once per battle round, when an attack is allocated to this model, you can change the Damage characteristic of that attack to 0.',
    factionId: 'WE',
    datasheetId: '000003645',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_inviolable_transport_000003646',
    label: 'Mastodon — Daño a 0 (Inviolable Transport)',
    description: 'Once per battle round, when an attack is allocated to this model, you can change the Damage characteristic of that attack to 0.',
    factionId: 'CSM',
    datasheetId: '000003646',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── CSM/DG/SM/TS/WE — Line-breaker ──
  {
    id: 'gap_line_breaker_000001175',
    label: 'Kratos — +1 impactar disparo (Line-breaker)',
    description: 'When making ranged attacks, this model can target enemy units within Engagement Range of it with Blast weapons. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'SM',
    datasheetId: '000001175',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_line_breaker_000003631',
    label: 'Kratos — +1 impactar disparo (Line-breaker)',
    description: 'When making ranged attacks, this model can target enemy units within Engagement Range of it with Blast weapons. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'TS',
    datasheetId: '000003631',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_line_breaker_000003632',
    label: 'Kratos — +1 impactar disparo (Line-breaker)',
    description: 'When making ranged attacks, this model can target enemy units within Engagement Range of it with Blast weapons. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'DG',
    datasheetId: '000003632',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_line_breaker_000003633',
    label: 'Kratos — +1 impactar disparo (Line-breaker)',
    description: 'When making ranged attacks, this model can target enemy units within Engagement Range of it with Blast weapons. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'WE',
    datasheetId: '000003633',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_line_breaker_000003634',
    label: 'Kratos — +1 impactar disparo (Line-breaker)',
    description: 'When making ranged attacks, this model can target enemy units within Engagement Range of it with Blast weapons. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'CSM',
    datasheetId: '000003634',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  // ── CSM/DG/SM/TS/WE — Sunderer of Fortresses ──
  {
    id: 'gap_sunderer_000000093',
    label: 'Typhon — +1 F/Daño vs Vehículo (Sunderer of Fortresses)',
    description: 'Each time this model makes an attack that targets a VEHICLE, improve the Strength and Damage characteristic of that attack by 1.',
    factionId: 'SM',
    datasheetId: '000000093',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_sunderer_000003679',
    label: 'Typhon — +1 F/Daño vs Vehículo (Sunderer of Fortresses)',
    description: 'Each time this model makes an attack that targets a VEHICLE, improve the Strength and Damage characteristic of that attack by 1.',
    factionId: 'TS',
    datasheetId: '000003679',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_sunderer_000003680',
    label: 'Typhon — +1 F/Daño vs Vehículo (Sunderer of Fortresses)',
    description: 'Each time this model makes an attack that targets a VEHICLE, improve the Strength and Damage characteristic of that attack by 1.',
    factionId: 'DG',
    datasheetId: '000003680',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_sunderer_000003681',
    label: 'Typhon — +1 F/Daño vs Vehículo (Sunderer of Fortresses)',
    description: 'Each time this model makes an attack that targets a VEHICLE, improve the Strength and Damage characteristic of that attack by 1.',
    factionId: 'WE',
    datasheetId: '000003681',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_sunderer_000003682',
    label: 'Typhon — +1 F/Daño vs Vehículo (Sunderer of Fortresses)',
    description: 'Each time this model makes an attack that targets a VEHICLE, improve the Strength and Damage characteristic of that attack by 1.',
    factionId: 'CSM',
    datasheetId: '000003682',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  // ── CSM/DG/SM/TS/WE — Titan-killer ──
  {
    id: 'gap_titan_killer_000001666',
    label: 'Falchion — Devastating Wounds disparo vs Monstruo/Vehículo (Titan-killer)',
    ...
    factionId: 'SM',
    datasheetId: '000001666',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_titan_killer_000003687',
    label: 'Falchion — Devastating Wounds disparo vs Monstruo/Vehículo (Titan-killer)',
    description: 'Each time this model makes a ranged attack with its twin Falchion volcano cannon that targets a MONSTER or VEHICLE unit, that attack has the [DEVASTATING WOUNDS] ability.',
    factionId: 'TS',
    datasheetId: '000003687',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_titan_killer_000003688',
    label: 'Falchion — Devastating Wounds disparo vs Monstruo/Vehículo (Titan-killer)',
    description: 'Each time this model makes a ranged attack with its twin Falchion volcano cannon that targets a MONSTER or VEHICLE unit, that attack has the [DEVASTATING WOUNDS] ability.',
    factionId: 'DG',
    datasheetId: '000003688',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_titan_killer_000003689',
    label: 'Falchion — Devastating Wounds disparo vs Monstruo/Vehículo (Titan-killer)',
    description: 'Each time this model makes a ranged attack with its twin Falchion volcano cannon that targets a MONSTER or VEHICLE unit, that attack has the [DEVASTATING WOUNDS] ability.',
    factionId: 'WE',
    datasheetId: '000003689',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_titan_killer_000003690',
    label: 'Falchion — Devastating Wounds disparo vs Monstruo/Vehículo (Titan-killer)',
    description: 'Each time this model makes a ranged attack with its twin Falchion volcano cannon that targets a MONSTER or VEHICLE unit, that attack has the [DEVASTATING WOUNDS] ability.',
    factionId: 'CSM',
    datasheetId: '000003690',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  // ── CSM/SM — Annihilator ──
  {
    id: 'gap_annihilator_000002572',
    label: 'Chaos Predator Annihilator — repetir Daño disparo vs Monstruo/Vehículo',
    ...
    factionId: 'CSM',
    datasheetId: '000002572',
    combatType: 'ranged',
    effects: { rerollAllDamage: true },
  },
  {
    id: 'gap_annihilator_000002714',
    label: 'Predator Annihilator — repetir Daño disparo vs Monstruo/Vehículo',
    description: 'Each time a ranged attack made by this model is allocated to a MONSTER or VEHICLE model, you can re-roll the Damage roll.',
    factionId: 'SM',
    datasheetId: '000002714',
    combatType: 'ranged',
    effects: { rerollAllDamage: true },
  },
  // ── CSM/SM/TS — Siege Shield ──
  {
    id: 'gap_siege_shield_000000964',
    label: 'Chaos Vindicator — +1 impactar disparo (Siege Shield)',
    description: 'When making ranged attacks with its demolisher cannon, this model can target enemy units within Engagement Range of it. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'CSM',
    datasheetId: '000000964',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_siege_shield_000001027',
    label: 'Chaos Vindicator — +1 impactar disparo (Siege Shield)',
    description: 'When making ranged attacks with its demolisher cannon, this model can target enemy units within Engagement Range of it. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'TS',
    datasheetId: '000001027',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_siege_shield_000001188',
    label: 'Vindicator — +1 impactar disparo (Siege Shield)',
    description: 'When making ranged attacks with its demolisher cannon, this model can target enemy units within Engagement Range of it. In addition, when making ranged attacks, this model does not suffer the penalty to its Hit rolls for being within Engagement Range of one or more enemy units.',
    factionId: 'SM',
    datasheetId: '000001188',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  // ── DG ──
  {
    id: 'gap_dg_blistering_fusillade',
    label: 'Blightlord Terminators — +1 F/PA disparo (Blistering Fusillade)',
    ...
    factionId: 'DG',
    datasheetId: '000001372',
    combatType: 'ranged',
    effects: { strengthMod: 1, apMod: 1 },
  },
  {
    id: 'gap_dg_malicious_calculations',
    label: 'Tallyman — +1 impactar (Líder, Malicious Calculations)',
    ...
    factionId: 'DG',
    leaderDatasheetId: '000001370',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_dg_pestilent_familiar',
    label: 'Death Guard Sorcerer In Terminator Armour — +2 F/Daño (Pestilent Familiar)',
    ...
    factionId: 'DG',
    datasheetId: '000001041',
    effects: { strengthMod: 2, damageMod: 2 },
  },
  {
    id: 'gap_dg_putrescent_vitality',
    label: 'Death Guard Sorcerer In Terminator Armour — -1 Daño recibido (Putrescent Vitality)',
    ...
    factionId: 'DG',
    leaderDatasheetId: '000001041',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── DRU ──
  {
    id: 'gap_dru_battlefield_butchery',
    label: 'Hellions — +1 A/F CaC (Pain token, Battlefield Butchery)',
    ...
    factionId: 'DRU',
    datasheetId: '000000659',
    combatType: 'melee',
    effects: { attacksMod: 1, strengthMod: 1 },
  },
  {
    id: 'gap_dru_grav_talon',
    label: 'Reavers — Lethal Hits CaC (Grav-talon)',
    description: 'The bearer’s melee weapons have an Armour Penetration characteristic of -2 and the [LETHAL HITS] ability.',
    factionId: 'DRU',
    datasheetId: '000000658',
    combatType: 'melee',
    effects: { lethalHitsBonus: true },
  },
  // ── EC ──
  {
    id: 'gap_ec_beguiling_form',
    label: 'Fulgrim — -1 impactar recibido (Beguiling Form)',
  ...
  {
    id: 'gap_ec_daemonic_patrons',
    label: 'Flawless Blades — crítico herida 3+ CaC (Daemonic Patrons)',
    description: 'Each time this unit is selected to fight, it can call upon daemonic patrons. If it does, until the end of the phase, each time a model in this unit makes an attack, an unmodified Wound roll of 3+ scores a Critical Wound.',
    factionId: 'EC',
    datasheetId: '000004089',
    combatType: 'melee',
    effects: { woundCritThreshold: 3 },
  },
  {
    id: 'gap_ec_stimulated_by_pain',
    label: 'Daemon Prince of Slaanesh with Wings — -1 Daño recibido (Stimulated by Pain)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'EC',
  ...
  // ── GC ──
  {
    id: 'gap_gc_ablative_plating',
    label: 'Rogal Dorn Battle Tank — Daño a 0 (Ablative Plating)',
    ...
    factionId: 'GC',
    datasheetId: '000003987',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_gc_might_from_beyond',
    label: 'Patriarch — Devastating Wounds CaC (Líder, Might From Beyond)',
    ...
    factionId: 'GC',
    leaderDatasheetId: '000000507',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  // ── GC/TYR ──
  {
    id: 'gap_gc_tyr_swallow_whole_000004225',
    label: 'The Red Terror — crítico herida 2+ (Swallow Whole)',
    description: 'Each time an attack with this model’s gaping maw targets an INFANTRY, MOUNTED or BEASTS unit, each successful unmodified Wound roll is a Critical Wound.',
    factionId: 'TYR',
    datasheetId: '000004225',
    combatType: 'melee',
    effects: { woundCritThreshold: 2 },
  },
  {
    id: 'gap_gc_tyr_swallow_whole_000004226',
    label: 'The Red Terror — crítico herida 2+ (Swallow Whole)',
    description: 'Each time an attack with this model’s gaping maw targets an INFANTRY, MOUNTED or BEASTS unit, each successful unmodified Wound roll is a Critical Wound.',
    factionId: 'GC',
    datasheetId: '000004226',
    combatType: 'melee',
    effects: { woundCritThreshold: 2 },
  },
  // ── GC/UN — FORTIFICATION (-1 impactar, asediada) ──
  {
    id: 'gap_gc_un_fortification_000000785',
    label: 'Imperial Fortress Walls — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000785',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000786',
    label: 'Primaris Redoubt — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000786',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000914',
    label: 'Bastion — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000914',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000917',
    label: 'Vengeance Weapon Battery — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000917',
    effects: { hitMod: -1 },
  ...
  {
    id: 'gap_gc_un_fortification_000000918',
    label: 'Firestorm Redoubt — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000918',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000919',
    label: 'Plasma Obliterator — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000919',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000920',
    label: 'Macro-cannon Aquila Strongpoint — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000920',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000921',
    label: 'Vortex Missile Strongpoint — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000921',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000922',
    label: 'Void Shield Generator — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000922',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000000923',
    label: 'Skyshield Landing Pad — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000000923',
    effects: { hitMod: -1 },
  ...
  {
    id: 'gap_gc_un_fortification_000002807',
    label: 'Castellum Stronghold — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000002807',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000002808',
    label: 'Wall Of Martyrs Bunker — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000002808',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000002809',
    label: 'Wall Of Martyrs Defence Line — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000002809',
    effects: { hitMod: -1 },
  ...
  {
    id: 'gap_gc_un_fortification_000002810',
    label: 'Wall Of Martyrs Defence Emplacement — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000002810',
    effects: { hitMod: -1 },
  ...
  {
    id: 'gap_gc_un_fortification_000002811',
    label: 'Aegis Defence Line With Weapon Emplacement — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'UN',
    datasheetId: '000002811',
    effects: { hitMod: -1 },
  ...
  {
    id: 'gap_gc_un_fortification_000001576',
    label: 'Tectonic Fragdrill — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'GC',
    datasheetId: '000001576',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_gc_un_fortification_000003957',
    label: 'Hydra Platform — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'GC',
    datasheetId: '000003957',
    effects: { hitMod: -1 },
  ...
  {
    id: 'gap_gc_un_fortification_000003958',
    label: 'Manticore Platform — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'GC',
    datasheetId: '000003958',
    effects: { hitMod: -1 },
  ...
  {
    id: 'gap_gc_un_fortification_000003959',
    label: 'Sabre Weapons Battery — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'GC',
    datasheetId: '000003959',
    effects: { hitMod: -1 },
  ...
  // ── UN ──
  {
    id: 'gap_un_inviolable_bastion',
    label: 'Wall Of Martyrs Bunker — -1 Daño recibido (Inviolable Bastion)',
    description: 'Each time an attack is allocated to this FORTIFICATION, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'UN',
    datasheetId: '000002808',
    target: 'defender',
    effects: { damageReduction: 1 },
  ...
  // ── LoV ──
  {
    id: 'gap_lov_conversion_000002603',
    label: 'Brôkhyr Thunderkyn — crítico impacto 4+ (Conversion)',
    description: 'Each time a model in this unit makes a ranged attack, an unmodified Hit roll of 4+ scores a Critical Hit.',
    factionId: 'LoV',
    datasheetId: '000002603',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_lov_conversion_000002604',
    label: 'Hekaton Land Fortress — crítico impacto 4+ (Conversion)',
    description: 'Each time this model makes a ranged attack, an unmodified Hit roll of 4+ scores a Critical Hit.',
    factionId: 'LoV',
    datasheetId: '000002604',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  },
  {
    id: 'gap_lov_multicog_targeting',
    label: 'Hekaton Land Fortress — +1 impactar disparo (MultiCOG Targeting)',
    description: 'Each time this model makes a ranged attack, you can re-roll the Hit roll, or add 1 to that Hit roll.',
    factionId: 'LoV',
    datasheetId: '000002604',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  ...
  {
    id: 'gap_lov_panspectral_scanner_000002601',
    label: 'Hernkyn Pioneers — repetir impacto de 1 disparo (Panspectral Scanner)',
    description: 'Each time a model in this unit makes a ranged attack, you can re-roll a Hit roll of 1.',
    factionId: 'LoV',
    datasheetId: '000002601',
    combatType: 'ranged',
    effects: { rerollHitsOf1: true },
  },
  {
    id: 'gap_lov_panspectral_scanner_000002604',
    label: 'Hekaton Land Fortress — repetir impacto de 1 disparo (Panspectral Scanner)',
    description: 'Each time this model makes a ranged attack, you can re-roll a Hit roll of 1.',
    factionId: 'LoV',
    datasheetId: '000002604',
    combatType: 'ranged',
    effects: { rerollHitsOf1: true },
  ...
  {
    id: 'gap_lov_rampart_crest',
    label: 'Ûthar the Destined — FNP 5+ (Líder, Rampart Crest)',
    description: 'While this model is leading a unit, models in that unit have the Feel No Pain 5+ ability.',
    factionId: 'LoV',
    leaderDatasheetId: '000002593',
    target: 'defender',
    effects: { feelNoPainThreshold: 5 },
  },
  {
    id: 'gap_lov_rollbar_searchlight',
    label: 'Hernkyn Pioneers — +1 impactar disparo (Rollbar Searchlight)',
    description: 'Each time a model in this unit makes a ranged attack that targets a unit within 18", you can re-roll the Hit roll.',
    factionId: 'LoV',
    datasheetId: '000002601',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  ...
  {
    id: 'gap_lov_weavefield_crest',
    label: 'Einhyr Champion — FNP 4+ (Líder, Weavefield Crest)',
    description: 'While this model is leading a unit, models in that unit have the Feel No Pain 4+ ability.',
    factionId: 'LoV',
    leaderDatasheetId: '000002595',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  // ── NEC ──
  {
    id: 'gap_nec_flesh_hunger',
    label: 'Flayed Ones — crítico herida 2+ (Flesh Hunger)',
    description: 'Each time a model in this unit makes a melee attack, an unmodified Wound roll of 2+ scores a Critical Wound.',
    factionId: 'NEC',
    datasheetId: '000000538',
    combatType: 'melee',
    effects: { woundCritThreshold: 2 },
  },
  {
    id: 'gap_nec_harbinger_of_destruction',
    label: 'Plasmancer — crítico impacto 5+ (Líder, Harbinger of Destruction)',
    description: 'While this model is leading a unit, each time a model in that unit makes a ranged attack, an unmodified Hit roll of 5+ scores a Critical Hit.',
    factionId: 'NEC',
    leaderDatasheetId: '000002108',
    combatType: 'ranged',
    effects: { critThreshold: 5 },
  },
  {
    id: 'gap_nec_implacable_resilience',
    label: 'Overlord — -1 Daño recibido (Implacable Resilience)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'NEC',
    datasheetId: '000000523',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_nec_inescapable_death',
    label: 'Hexmark Destroyer — Overwatch 2+ (Inescapable Death)',
    description: 'Each time this model fires Overwatch, hit rolls of 2+ are successful (instead of only 6s).',
    factionId: 'NEC',
    datasheetId: '000002355',
    combatType: 'ranged',
    effects: { overwatchThreshold: 2 },
  },
  {
    id: 'gap_nec_necrodermis_000000541',
    label: 'C’tan Shard of the Nightbringer — -1 Daño recibido (Necrodermis)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'NEC',
    datasheetId: '000000541',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_nec_necrodermis_000000542',
    label: 'C’tan Shard of the Deceiver — -1 Daño recibido (Necrodermis)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'NEC',
    datasheetId: '000000542',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_nec_necrodermis_000000555',
    label: 'Transcendent C’tan — -1 Daño recibido (Necrodermis)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'NEC',
    datasheetId: '000000555',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_nec_necrodermis_000002357',
    label: 'C’tan Shard of the Void Dragon — -1 Daño recibido (Necrodermis)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'NEC',
    datasheetId: '000002357',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_nec_plasmacyte',
    label: 'Ophydian Destroyers — Devastating Wounds CaC (Plasmacyte)',
    description: 'Melee weapons equipped by models in this unit have the [DEVASTATING WOUNDS] ability.',
    factionId: 'NEC',
    datasheetId: '000002358',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_nec_weapon_sentinels',
    label: 'Canoptek Tomb Crawlers — +1 impactar disparo (Weapon Sentinels)',
    description: 'Each time a model in this unit makes a ranged attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'NEC',
    datasheetId: '000004177',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  // ── NEC — FORTIFICATION (-1 impactar) ──
  {
    id: 'gap_nec_fortification_000000562',
    label: 'Sentry Pylon — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'NEC',
    datasheetId: '000000562',
    effects: { hitMod: -1 },
  },
  {
    id: 'gap_nec_fortification_000002362',
    label: 'Tomb Citadel Walls — -1 impactar (FORTIFICATION)',
    description: 'While an enemy unit is only within Engagement Range of one or more Fortifications from your army: that unit can still be selected as the target of ranged attacks, but each time such an attack is made, unless it is made with a Pistol, subtract 1 from the Hit roll.',
    factionId: 'NEC',
    datasheetId: '000002362',
    effects: { hitMod: -1 },
  },
  // ── ORK ──
  {
    id: 'gap_ork_waaagh_energy',
    label: 'Weirdboy — +1 F/Daño disparo (Líder, Waaagh! Energy)',
    description: 'While this model is leading a unit, each time a model in that unit makes a ranged attack that targets a unit within 12", improve the Strength and Damage characteristics of that attack by 1.',
    factionId: 'ORK',
    leaderDatasheetId: '000000004',
    combatType: 'ranged',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_ork_walking_bastion',
    label: 'Gargantuan Squiggoth — +1 impactar disparo (Walking Bastion)',
    description: 'Each time this model makes a ranged attack, it does not suffer the penalty to the Hit roll for being within Engagement Range of one or more enemy units.',
    factionId: 'ORK',
    datasheetId: '000000059',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  // ── QI/QT ──
  {
    id: 'gap_qi_magaeras_duty',
    label: 'Questoris Knight Magaera — +1 F/PA disparo (Magaera’s Duty)',
    description: 'Each time this model makes a ranged attack that targets a unit that has the Benefit of Cover, improve the Strength and Armour Penetration characteristics of that attack by 1.',
    factionId: 'QI',
    datasheetId: '000000865',
    combatType: 'ranged',
    effects: { strengthMod: 1, apMod: 1 },
  },
  {
    id: 'gap_qi_sunderer_of_fortresses_000001664',
    label: 'Acastus Knight Asterius — +1 F/Daño disparo vs FORTIFICATION (Sunderer of Fortresses)',
    description: 'Each time this model makes a ranged attack that targets a FORTIFICATION unit, improve the Strength and Damage characteristics of that attack by 1.',
    factionId: 'QI',
    datasheetId: '000001664',
    combatType: 'ranged',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_qt_sunderer_of_fortresses_000001662',
    label: 'Chaos Acastus Knight Asterius — +1 F/Daño disparo vs FORTIFICATION (Sunderer of Fortresses)',
    description: 'Each time this model makes a ranged attack that targets a FORTIFICATION unit, improve the Strength and Damage characteristics of that attack by 1.',
    factionId: 'QT',
    datasheetId: '000001662',
    combatType: 'ranged',
    effects: { strengthMod: 1, damageMod: 1 },
  },
  {
    id: 'gap_qi_titan_hunter',
    label: 'Knight Castellan — repetir Daño disparo (Titan Hunter)',
    description: 'Each time this model makes a ranged attack that targets a MONSTER or VEHICLE unit, you can re-roll the Damage roll.',
    factionId: 'QI',
    datasheetId: '000001485',
    combatType: 'ranged',
    effects: { rerollAllDamage: true },
  },
  {
    id: 'gap_qt_conversion_000001662',
    label: 'Chaos Acastus Knight Asterius — crítico impacto 4+ (Conversion)',
    description: 'Each time this model makes a ranged attack, an unmodified Hit roll of 4+ scores a Critical Hit.',
    factionId: 'QT',
    datasheetId: '000001662',
    combatType: 'ranged',
  ...
  {
    id: 'gap_qi_conversion_000001664',
    label: 'Acastus Knight Asterius — crítico impacto 4+ (Conversion)',
    description: 'Each time this model makes a ranged attack, an unmodified Hit roll of 4+ scores a Critical Hit.',
    factionId: 'QI',
    datasheetId: '000001664',
    combatType: 'ranged',
  ...
  {
    id: 'gap_qi_conversion_000004149',
    label: 'Knight Defender — crítico 4+ a >18" (Conversion)',
    description: 'Each time an attack is made with this weapon, if the target is more than 18" away from the bearer, an unmodified successful Hit roll of 4+ scores a Critical Hit.',
    factionId: 'QI',
    datasheetId: '000004149',
    combatType: 'ranged',
    effects: { critThreshold: 4 },
  ...
  {
    id: 'gap_qt_seething_hatred',
    label: 'Knight Despoiler — repetir impacto/herida (Seething Hatred)',
    description: 'Each time a model in this unit makes an attack, you can re-roll the Hit roll and you can re-roll the Wound roll.',
    factionId: 'QT',
    datasheetId: '000001658',
    effects: { rerollAllHits: true, rerollAllWounds: true },
  },
  // ── SM ──
  {
    id: 'gap_sm_annihilator_000001178',
    label: 'Vindicator Laser Destroyer — repetir Daño de 1 disparo (Annihilator)',
    description: 'Each time this model makes a ranged attack that targets a MONSTER or VEHICLE unit, you can re-roll a Damage roll of 1.',
    factionId: 'SM',
    datasheetId: '000001178',
    combatType: 'ranged',
    effects: { rerollDamageOf1: true },
  },
  {
    id: 'gap_sm_aquilon_optics_000002705',
    label: 'Gladiator Lancer — repetir impacto/herida/daño disparo (Aquilon Optics)',
    description: 'Each time this model makes a ranged attack, you can re-roll the Hit roll, you can re-roll the Wound roll, and you can re-roll the Damage roll.',
    factionId: 'SM',
    datasheetId: '000002705',
    combatType: 'ranged',
    effects: { rerollAllHits: true, rerollAllWounds: true, rerollAllDamage: true },
  },
  {
    id: 'gap_sm_aquilon_optics_000002787',
    label: 'Gladiator Lancer — repetir impacto/herida/daño disparo (Aquilon Optics)',
    description: 'Each time this model makes a ranged attack, you can re-roll the Hit roll, you can re-roll the Wound roll, and you can re-roll the Damage roll.',
    factionId: 'SM',
    datasheetId: '000002787',
    combatType: 'ranged',
    effects: { rerollAllHits: true, rerollAllWounds: true, rerollAllDamage: true },
  },
  {
    id: 'gap_sm_blizzard_shield_000002801',
    label: 'Venerable Dreadnought — FNP 4+ (Blizzard Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000002801',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_sm_blizzard_shield_000004133',
    label: 'Wulfen Dreadnought — FNP 4+ (Blizzard Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000004133',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_sm_catechism_of_death_000002678',
    label: 'Chaplain Cassius — Devastating Wounds CaC (Líder, Catechism of Death)',
    description: 'While this model is leading a unit, melee weapons equipped by models in that unit have the [DEVASTATING WOUNDS] ability.',
    factionId: 'SM',
    leaderDatasheetId: '000002678',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_sm_crusade_of_wrath',
    label: 'High Marshal Helbrecht — +1 A/F CaC (Líder, Crusade of Wrath)',
    description: 'While this model is leading a unit, each time that unit ends a Charge move, until the end of the turn, add 1 to the Attacks and Strength characteristics of melee weapons equipped by models in that unit.',
    factionId: 'SM',
    leaderDatasheetId: '000002794',
    combatType: 'melee',
    effects: { attacksMod: 1, strengthMod: 1 },
  },
  {
    id: 'gap_sm_death_totem',
    label: 'Wulfen — repetir impacto de 1 CaC (Death Totem)',
    description: 'Each time a model in this unit makes a melee attack, you can re-roll a Hit roll of 1.',
    factionId: 'SM',
    datasheetId: '000000311',
    combatType: 'melee',
    effects: { rerollHitsOf1: true },
  },
  {
    id: 'gap_sm_death_hold',
    label: 'Carab Culln The Risen — +1 impactar disparo (Death-hold)',
    description: 'Each time this model makes a ranged attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'SM',
    datasheetId: '000000096',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_sm_headhunters',
    label: 'Wolf Guard Headtakers — Devastating Wounds CaC (Headhunters)',
    description: 'Each time a model in this unit makes a melee attack that targets a CHARACTER unit, that attack has the [DEVASTATING WOUNDS] ability.',
    factionId: 'SM',
    datasheetId: '000004131',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_sm_indomitor_doctrines',
    label: 'Indomitor Kill Team — +2 Fuerza (Indomitor Doctrines)',
    description: 'Add 2 to the Strength characteristic of this unit’s weapons.',
    factionId: 'SM',
    datasheetId: '000002781',
    effects: { strengthMod: 2 },
  },
  {
    id: 'gap_sm_inner_circle',
    label: 'Deathwing Knights — -1 Daño recibido (Inner Circle)',
    description: 'Each time an attack is allocated to a model in this unit, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'SM',
    datasheetId: '000000231',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_sm_lord_of_the_wolfkin',
    label: 'Harald Deathwolf — Devastating Wounds CaC (Líder, Lord of the Wolfkin)',
    description: 'While this model is leading a unit, melee weapons equipped by models in that unit have the [DEVASTATING WOUNDS] ability.',
    factionId: 'SM',
    leaderDatasheetId: '000000287',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_sm_mantle_of_the_troll_king',
    label: 'Harald Deathwolf — -1 Daño recibido (Mantle of the Troll King)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'SM',
    datasheetId: '000000287',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'gap_sm_mass_of_doom',
    label: 'Astorath — Devastating Wounds CaC (Mass of Doom)',
    description: 'This model’s melee weapons have the [DEVASTATING WOUNDS] ability.',
    factionId: 'SM',
    datasheetId: '000000157',
    combatType: 'melee',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_sm_refractor_field',
    label: 'Wardens of Ultramar — FNP 5+ (Refractor Field)',
    description: 'The bearer has a 5+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000004188',
    target: 'defender',
    effects: { feelNoPainThreshold: 5 },
  },
  {
    id: 'gap_sm_sentinel_protocols_000000086',
    label: 'Firestrike Servo-turrets — Overwatch 4+ (Sentinel Protocols)',
    description: 'Each time this unit fires Overwatch, hit rolls of 4+ are successful (instead of only 6s).',
    factionId: 'SM',
    datasheetId: '000000086',
    combatType: 'ranged',
    effects: { overwatchThreshold: 4 },
  },
  {
    id: 'gap_sm_sentinel_protocols_000000098',
    label: 'Tarantula Sentry Battery — Overwatch 4+ (Sentinel Protocols)',
    description: 'Each time this unit fires Overwatch, hit rolls of 4+ are successful (instead of only 6s).',
    factionId: 'SM',
    datasheetId: '000000098',
    combatType: 'ranged',
    effects: { overwatchThreshold: 4 },
  },
  {
    id: 'gap_sm_shield_dome_000002568',
    label: 'Impulsor — FNP 5+ (Shield Dome)',
    description: 'This model’s unit has a 5+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000002568',
    target: 'defender',
    effects: { feelNoPainThreshold: 5 },
  },
  {
    id: 'gap_sm_shield_dome_000002786',
    label: 'Impulsor — FNP 5+ (Shield Dome)',
    description: 'This model’s unit has a 5+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000002786',
    target: 'defender',
    effects: { feelNoPainThreshold: 5 },
  },
  {
    id: 'gap_sm_siege_captain',
    label: 'Tor Garadon — +2 F/PA/Daño CaC',
    description: 'Add 2 to the Strength, Armour Penetration and Damage characteristics of this model’s melee weapons.',
    factionId: 'SM',
    datasheetId: '000002473',
    combatType: 'melee',
    effects: { strengthMod: 2, apMod: 2, damageMod: 2 },
  },
  {
    id: 'gap_sm_specialised_weapon_system',
    label: 'Sicaran Arcus — +1 impactar disparo (Specialised Weapon System)',
    description: 'Each time this model makes a ranged attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'SM',
    datasheetId: '000001161',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_sm_storm_shield_000002802',
    label: 'Wolf Guard Pack Leader With Jump Pack — FNP 4+ (Storm Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000002802',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_sm_storm_shield_000002804',
    label: 'Wolf Guard Pack Leader — FNP 4+ (Storm Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000002804',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_sm_storm_shield_000004131',
    label: 'Wolf Guard Headtakers — FNP 4+ (Storm Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000004131',
    target: 'defender',
  ...
  {
    id: 'gap_sm_storm_shield_000004188',
    label: 'Wardens of Ultramar — FNP 4+ (Storm Shield)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'SM',
    datasheetId: '000004188',
    target: 'defender',
  ...
  {
    id: 'gap_sm_tank_commander',
    label: 'Sergeant Chronus — repetir herida (Tank Commander)',
    description: 'Each time this model makes an attack, you can re-roll the Wound roll.',
    factionId: 'SM',
    datasheetId: '000001524',
    effects: { rerollAllWounds: true },
  },
  {
    id: 'gap_sm_thunderous_impact',
    label: 'Outrider Squad — +1 F/Daño CaC (Thunderous Impact)',
    description: 'Each time a model in this unit makes a melee attack, improve the Strength and Damage characteristics of that attack by 1.',
    factionId: 'SM',
  ...
  {
    id: 'gap_sm_tyrannic_war_veterans',
    label: 'Tyrannic War Veterans — Devastating Wounds',
    description: 'Weapons equipped by models in this unit have the [DEVASTATING WOUNDS] ability.',
    factionId: 'SM',
    datasheetId: '000002725',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'gap_sm_unrelenting_and_uncompromising',
    label: 'Ferren Areios — +1 impactar (Líder, Unrelenting and Uncompromising)',
    description: 'While this model is leading a unit, each time a model in that unit makes an attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'SM',
    leaderDatasheetId: '000004204',
    effects: { hitMod: 1 },
  },
  // ── TAU ──
  {
    id: 'gap_tau_nova_charge',
    label: 'Riptide Battlesuit — Devastating Wounds disparo (Nova Charge)',
    description: 'Each time this model makes a ranged attack with its riptide fists/heavy weapon, that attack has the [DEVASTATING WOUNDS] ability.',
    factionId: 'TAU',
  ...
  {
    id: 'gap_tau_shield_generator_000000402',
    label: 'Commander In Coldstar Battlesuit — FNP 4+ (Shield Generator)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'TAU',
  ...
  {
    id: 'gap_tau_shield_generator_000000418',
    label: 'Crisis Battlesuits — FNP 4+ (Shield Generator)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'TAU',
    datasheetId: '000000418',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_tau_shield_generator_000000443',
    label: 'Xv9 Hazard Battlesuits — FNP 4+ (Shield Generator)',
    description: 'The bearer has a 4+ invulnerable save.',
    factionId: 'TAU',
    datasheetId: '000000443',
    target: 'defender',
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'gap_tau_weapon_support_system_000000402',
    label: 'Commander In Coldstar Battlesuit — +1 impactar disparo (Weapon Support System)',
  ...
  {
    id: 'gap_tau_weapon_support_system_000000418',
    label: 'Crisis Battlesuits — +1 impactar disparo (Weapon Support System)',
    description: 'Each time the bearer makes a ranged attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'TAU',
    datasheetId: '000000418',
    combatType: 'ranged',
  ...
  {
    id: 'gap_tau_weapon_support_system_000000443',
    label: 'Xv9 Hazard Battlesuits — +1 impactar disparo (Weapon Support System)',
    description: 'Each time the bearer makes a ranged attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'TAU',
    datasheetId: '000000443',
    combatType: 'ranged',
  ...
  {
    id: 'gap_tau_weapon_support_system_000000421',
    label: 'Riptide Battlesuit — +1 impactar disparo (Weapon Support System)',
    description: 'Each time the bearer makes a ranged attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'TAU',
    datasheetId: '000000421',
    combatType: 'ranged',
  ...
  {
    id: 'gap_tau_weapon_support_system_000000444',
    label: 'Y’vahra Battlesuit — +1 impactar disparo (Weapon Support System)',
    description: 'Each time the bearer makes a ranged attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'TAU',
    datasheetId: '000000444',
    combatType: 'ranged',
    effects: { hitMod: 1 },
  },
  // ── TS ──
  {
    id: 'gap_ts_ensorcelled_destruction',
    label: 'Chaos Predator Destructor — +1 F/PA disparo (Ensorcelled Destruction)',
    description: 'Each time this model makes a ranged attack, improve the Strength and Armour Penetration characteristics of that attack by 1.',
    factionId: 'TS',
    datasheetId: '000001026',
    combatType: 'ranged',
    effects: { strengthMod: 1, apMod: 1 },
  },
  {
    id: 'gap_ts_impossible_form',
    label: 'Magnus The Red — -1 Daño recibido (Impossible Form)',
    description: 'Each time an attack is allocated to this model, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'TS',
    datasheetId: '000001031',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  // ── WE ──
  {
    id: 'gap_we_driven_by_ultimate_rage',
    label: 'Angron — +1 impactar CaC (aura, Driven by Ultimate Rage)',
    description: 'While a friendly WORLD EATERS unit is within 6" of this model, each time a model in that unit makes a melee attack, you can ignore any or all modifiers to the Hit roll.',
    factionId: 'WE',
    sourceDatasheetId: '000002621',
    combatType: 'melee',
    effects: { hitMod: 1 },
  },
  {
    id: 'gap_we_rend_and_tear',
    label: 'Exalted Eightbound — +1 Daño CaC (Rend and Tear)',
    description: 'Each time a model in this unit makes a melee attack, add 1 to the Damage characteristic of that attack.',
    factionId: 'WE',
    datasheetId: '000002631',
    combatType: 'melee',
    effects: { damageMod: 1 },
  },

  // ═══ Stratagems de Nuevos Destacamentos (bloque añadido tras revisión) ═══
  // Cobertura de detachments recién incorporados a las CSV que aún no tenían
  // ningún ModifierRule. Mismo criterio que el resto del archivo: solo se
  // modelan efectos representables como CombatModifiers; el resto se omite.
  // ═══ SM — Nuevos Destacamentos ═══
  {
    id: 'strat_new_sm_slayers_of_abominations',
    label: 'SLAYERS OF ABOMINATIONS — +2 Fuerza vs MONSTER/VEHICLE (SWORD BRETHREN SQUAD, CaC) (1PC)',
    description: 'Marshal’s Household: Fight phase, when a friendly Sword Brethren Squad unit is selected to fight. Until the end of the phase, your unit’s melee attacks that target a Monster or Vehicle unit have +2 to their Strength characteristic.',
    factionId: 'SM',
    detachmentId: '000001177',
    combatType: 'melee',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'sword brethren squad',
    effects: { strengthMod: 2 },
  },
  {
    id: 'strat_new_sm_martial_paragon',
    label: 'MARTIAL PARAGON — Lethal Hits (ADEPTUS ASTARTES CHARACTER) (1PC)',
    description: 'Legacy of Grace: Your Shooting phase or the Fight phase, when a friendly Adeptus Astartes Character unit is selected to attack. Until the end of the phase, your unit’s attacks have the [LETHAL HITS] ability (or [SUSTAINED HITS 1], your choice).',
    factionId: 'SM',
    detachmentId: '000001179',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'character',
    effects: { lethalHitsBonus: true },
  },
  {
    id: 'strat_new_sm_martial_paragon_2',
    label: 'MARTIAL PARAGON — Sustained Hits 1 (ADEPTUS ASTARTES CHARACTER) (1PC)',
    description: 'Legacy of Grace: Your Shooting phase or the Fight phase, when a friendly Adeptus Astartes Character unit is selected to attack. Until the end of the phase, your unit’s attacks have the [SUSTAINED HITS 1] ability (or [LETHAL HITS], your choice).',
    factionId: 'SM',
    detachmentId: '000001179',
    isStratagem: true,
    cpCost: 1,
  ...
  {
    id: 'strat_new_sm_aura_of_the_angels_grace',
    label: 'AURA OF THE ANGEL’S GRACE — salvación invulnerable 5+ (ADEPTUS ASTARTES CHARACTER, defensor) (1PC)',
    description: 'Legacy of Grace: Your opponent’s Shooting phase, when an enemy unit targets a friendly Adeptus Astartes Character unit. Until the end of the phase, your unit has a 5+ invulnerable save.',
    factionId: 'SM',
    detachmentId: '000001179',
    target: 'defender',
    isStratagem: true,
  ...
  {
    id: 'strat_new_sm_blinding_blurs_of_vengeance',
    label: 'BLINDING BLURS OF VENGEANCE — Stealth (SANGUINARY GUARD, defensor, disparo) (1PC)',
    description: 'Encarmine Speartip: Your opponent’s Shooting phase, when an enemy unit targets a friendly Sanguinary Guard unit. Until the end of the phase, your unit has the Stealth ability, worsening the attacker’s BS characteristic by 1.',
    factionId: 'SM',
    detachmentId: '000001180',
    combatType: 'ranged',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    requiresTargetKeyword: 'sanguinary guard',
    effects: { bsMod: 1 },
  },
  {
    id: 'strat_new_sm_death_begets_vengeance',
    label: 'DEATH BEGETS VENGEANCE — +1 herir vs unidad odiada (DEATH COMPANY) (1PC)',
    description: 'Wrath of the Doomed: any phase, when a friendly Death Company unit is destroyed by an enemy unit, that enemy unit is hated until the end of the battle. While a unit is hated, friendly Death Company units’ attacks that target that unit have +1 to Wound rolls.',
    factionId: 'SM',
    detachmentId: '000001181',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'death company',
    effects: { woundMod: 1 },
  },
  {
    id: 'strat_new_sm_terrifying_zeal',
    label: 'TERRIFYING ZEAL — −1 impactar recibido (CHAPLAIN, defensor) (1PC)',
    description: 'Interrogation Conclave: Your Charge phase, when a friendly Chaplain unit ends a charge move. Select one enemy unit (excluding Monster/Vehicle) engaged with your unit; if that unit fails a Leadership test, its attacks have -1 to Hit rolls until the end of the turn.',
    factionId: 'SM',
    detachmentId: '000001184',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    effects: { hitMod: -1 },
  ...
  {
    id: 'strat_new_sm_grizzled_killers',
    label: 'GRIZZLED KILLERS — Sustained Hits 1 (GREY HUNTERS, CaC) (1PC)',
    description: 'Veterans of the Fang: Fight phase, when a friendly Grey Hunters unit is selected to fight. Until the end of the phase, your unit’s melee attacks have the [SUSTAINED HITS 1] ability (or [LETHAL HITS], your choice).',
    factionId: 'SM',
    detachmentId: '000001189',
    combatType: 'melee',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'grey hunters',
    effects: { sustainedHitsBonus: 1 },
  },
  {
    id: 'strat_new_sm_grizzled_killers_2',
    label: 'GRIZZLED KILLERS — Lethal Hits (GREY HUNTERS, CaC) (1PC)',
    description: 'Veterans of the Fang: Fight phase, when a friendly Grey Hunters unit is selected to fight. Until the end of the phase, your unit’s melee attacks have the [LETHAL HITS] ability (or [SUSTAINED HITS 1], your choice).',
    factionId: 'SM',
    detachmentId: '000001189',
    combatType: 'melee',
    isStratagem: true,
  ...
  // ═══ TAU — Nuevos Destacamentos ═══
  {
    id: 'strat_new_tau_autoreactive_camouflage',
    label: 'AUTOREACTIVE CAMOUFLAGE — +1 salvación estando oculto (PATHFINDER TEAM/STEALTH BATTLESUITS, defensor) (1PC)',
    description: 'Advanced Acquisition Cadre: Your opponent’s Shooting phase, when an enemy unit targets a friendly hidden Pathfinder Team or Stealth Battlesuits unit. Until the end of the phase, your unit has +1 to its Save characteristic.',
    factionId: 'TAU',
    detachmentId: '000001175',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    effects: { saveMod: 1 },
  ...
  // ═══ QT — Nuevos Destacamentos ═══
  {
    id: 'strat_new_qt_insensate_bloodthirst',
    label: 'INSENSATE BLOODTHIRST — Feel No Pain 5+ (WAR DOG, defensor, CaC) (1PC)',
    description: 'Hunting Warpack: Fight phase, when an enemy unit targets a friendly War Dog unit. Until the end of the phase, your unit has the Feel No Pain 5+ ability.',
    factionId: 'QT',
    detachmentId: '000001204',
    combatType: 'melee',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    requiresTargetKeyword: 'war dog',
    effects: { feelNoPainThreshold: 5 },
  },
  {
    id: 'strat_new_qt_stalking_focus',
    label: 'STALKING FOCUS — −1 PA recibido (WAR DOG, defensor, disparo) (1PC)',
    description: 'Hunting Warpack: Your opponent’s Shooting phase, when an enemy unit targets a friendly War Dog unit within range of an objective. Until that enemy unit has attacked, ranged attacks that target your unit are worsened by 1 to their Armour Penetration characteristic.',
    factionId: 'QT',
    detachmentId: '000001204',
    combatType: 'ranged',
    target: 'defender',
  ...
  // ═══ ORK — Nuevos Destacamentos ═══
  {
    id: 'strat_new_ork_loot_on_the_move',
    label: 'LOOT ON THE MOVE — −1 PA recibido (ORKS, defensor) (1PC)',
    description: 'Kaptin Killers: Your Movement phase, just after an Orks unit from your army opens a Hatchway. Until the end of the turn, each time an attack targets your unit, worsen the Armour Penetration characteristic of that attack by 1.',
    factionId: 'ORK',
    detachmentId: '000000964',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    effects: { apMod: -1 },
  ...
  // ═══ TS — Nuevos Destacamentos ═══
  {
    id: 'strat_new_ts_relentless_rebirth',
    label: 'RELENTLESS REBIRTH — Feel No Pain 5+ vs mortales (PSYKER, defensor) (1PC)',
    description: 'Ritual of Regeneration: any phase, when a friendly Infantry/Mounted Thousand Sons Psyker unit suffers a mortal wound. Your unit has the Feel No Pain 5+ ability against mortal wounds.',
    factionId: 'TS',
    detachmentId: '000001207',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    requiresTargetKeyword: 'psyker',
    effects: { feelNoPainThreshold: 5 },
  },

  // ═══ CD — Nuevos Destacamentos ═══
  { id: 'strat_new_cd_call_to_murder', label: 'CALL TO MURDER — +1A CaC (1PC)', description: 'Lords of the Warp: When a friendly LEGIONES DAEMONICA KHORNE CHARACTER unit that made a charge move this turn is selected to fight, until the end of the phase your unit’s melee attacks have +1 to their Attacks characteristic.', factionId: 'CD', detachmentId: '000001201', combatType: 'melee', isStratagem: true, cpCost: 1, effects: { attacksMod: 1 } },
  { id: 'strat_new_cd_skirling_magicks', label: 'SKIRLING MAGICKS — Lethal Hits a distancia (1PC)', description: 'Lords of the Warp: When a friendly LEGIONES DAEMONICA CHARACTER TZEENTCH unit is selected to shoot, until the end of the phase your unit’s ranged attacks have the [LETHAL HITS] ability.', factionId: 'CD', detachmentId: '000001201', combatType: 'ranged', isStratagem: true, cpCost: 1, effects: { lethalHitsBonus: true } },
  {
    id: 'strat_new_cd_incorporeal_entities',
    label: 'INCORPOREAL ENTITIES — −1 herir recibido a distancia (BATTLELINE, 1PC)',
    description: 'Warptide: When an enemy unit targets a friendly LEGIONES DAEMONICA BATTLELINE unit in your opponent’s Shooting phase, until the end of the phase ranged attacks that target your unit with a Strength greater than your unit’s Toughness have −1 to their Wound roll.',
    factionId: 'CD',
    detachmentId: '000001202',
    combatType: 'ranged',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'battleline',
    effects: { woundMod: -1 },
  },

  // ═══ CSM — Nuevos Destacamentos ═══
  {
    id: 'strat_new_csm_imperious_advance',
    label: 'IMPERIOUS ADVANCE — +1A CaC (TERMINATOR) (1PC)',
    description: 'Champions of Chaos: Select any number of models in a HERETIC ASTARTES TERMINATOR unit that has not been selected to fight this phase. Until the end of the phase, add 1 to the Attacks characteristic of melee weapons equipped by the selected models.',
    factionId: 'CSM',
    detachmentId: '000000948',
    combatType: 'melee',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'terminator',
    effects: { attacksMod: 1 },
  },
  {
    id: 'strat_new_csm_ruinations_bounty_havocs',
    label: 'RUINATION’S BOUNTY — Lethal Hits, Sustained Hits 1 (HAVOCS) (1PC)',
    description: 'Devotees of Destruction: When a friendly HAVOCS unit is selected to shoot, if your unit uses the Dark Pacts ability, until the end of the phase your unit’s ranged attacks have the [LETHAL HITS] and [SUSTAINED HITS 1] abilities.',
    factionId: 'CSM',
    detachmentId: '000001205',
    combatType: 'ranged',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'havocs',
    effects: { lethalHitsBonus: true, sustainedHitsBonus: 1 },
  },
  {
    id: 'strat_new_csm_ruinations_bounty_obliterators',
    label: 'RUINATION’S BOUNTY — Lethal Hits, Sustained Hits 1 (OBLITERATORS) (1PC)',
    description: 'Devotees of Destruction: When a friendly OBLITERATORS unit is selected to shoot, if your unit uses the Dark Pacts ability, until the end of the phase your unit’s ranged attacks have the [LETHAL HITS] and [SUSTAINED HITS 1] abilities.',
    factionId: 'CSM',
    detachmentId: '000001205',
    combatType: 'ranged',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'obliterators',
    effects: { lethalHitsBonus: true, sustainedHitsBonus: 1 },
  },
  {
    id: 'strat_new_csm_undying_hatred_havocs',
    label: 'UNDYING HATRED — −1 herir recibido a distancia (HAVOCS) (1PC)',
    description: 'Devotees of Destruction: When an enemy unit targets a friendly HAVOCS unit in your opponent’s Shooting phase, until the end of the phase ranged attacks that target your unit with a Strength greater than your unit’s Toughness have −1 to their Wound roll.',
    factionId: 'CSM',
    detachmentId: '000001205',
    combatType: 'ranged',
    target: 'defender',
  ...
  {
    id: 'strat_new_csm_undying_hatred_obliterators',
    label: 'UNDYING HATRED — −1 herir recibido a distancia (OBLITERATORS) (1PC)',
    description: 'Devotees of Destruction: When an enemy unit targets a friendly OBLITERATORS unit in your opponent’s Shooting phase, until the end of the phase ranged attacks that target your unit with a Strength greater than your unit’s Toughness have −1 to their Wound roll.',
    factionId: 'CSM',
    detachmentId: '000001205',
    combatType: 'ranged',
    target: 'defender',
  ...
  // ═══ EC — Nuevos Destacamentos ═══
  {
    id: 'strat_new_ec_delight_in_agony',
    label: 'DELIGHT IN AGONY — −1 herir recibido (TERMINATOR) (1PC)',
    description: 'Elegant Brutes: When an enemy unit targets a friendly EMPEROR’S CHILDREN TERMINATOR unit in your opponent’s Shooting phase or the Fight phase, until the end of the phase attacks that target your unit with a Strength greater than your unit’s Toughness have −1 to their Wound roll.',
    factionId: 'EC',
    detachmentId: '000001155',
    target: 'defender',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'terminator',
  ...
  {
    id: 'strat_new_ec_frenzied_ferocity_upgrade',
    label: 'FRENZIED FEROCITY UPGRADE — +2 Fuerza (TERMINATOR) (1PC)',
    description: 'Elegant Brutes: When a friendly EMPEROR’S CHILDREN TERMINATOR unit is selected to attack in your Shooting phase or the Fight phase, until the end of the phase your unit’s attacks have +2 to their Strength characteristic.',
    factionId: 'EC',
    detachmentId: '000001155',
    isStratagem: true,
    cpCost: 1,
  ...
  // ═══ GC — Nuevos Destacamentos ═══
  {
    id: 'strat_new_gc_fanatical_hail',
    label: 'FANATICAL HAIL — repetir impactos a distancia (NEOPHYTE HYBRIDS) (1PC)',
    description: 'Xenocult Masses: When a friendly NEOPHYTE HYBRIDS unit is selected to shoot, select one enemy unit; until the end of the phase your unit’s ranged attacks that target that enemy unit can re-roll Hit rolls.',
    factionId: 'GC',
    detachmentId: '000001198',
    combatType: 'ranged',
    isStratagem: true,
    cpCost: 1,
    requiresAttackerKeyword: 'neophyte hybrids',
    effects: { rerollAllHits: true },
  },
  {
    id: 'strat_new_gc_slunk_from_the_underbelly',
    label: 'SLUNK FROM THE UNDERBELLY — −1 PA recibido a distancia (NEOPHYTE HYBRIDS) (1PC)',
    description: 'Xenocult Masses: When an enemy unit targets a friendly NEOPHYTE HYBRIDS unit with every model within a terrain area in your opponent’s Shooting phase, until that unit has attacked, ranged attacks that target your unit have −1 to their Armour Penetration characteristic.',
    factionId: 'GC',
    detachmentId: '000001198',
    combatType: 'ranged',
    target: 'defender',
  ...
  // ═══ AdM — Nuevos Destacamentos ═══

  // ═══ AE — Nuevos Destacamentos ═══
  { id: 'strat_new_ae_presaged_rehearsal', label: 'PRESAGED REHEARSAL — Lance, CaC (TROUPE) (1PC)', description: 'Twilight Flickers: When a friendly TROUPE unit is selected to fight, until the end of the phase, that unit’s melee attacks have the [LANCE] ability (add 1 to the Wound roll if the bearer made a charge move this turn).', factionId: 'AE', detachmentId: '000001192', combatType: 'melee', isStratagem: true, cpCost: 1, requiresAttackerKeyword: 'troupe', effects: { woundMod: 1 } },

  // ═══ DG — Nuevos Destacamentos ═══
  { id: 'strat_new_dg_gnawing_hunger', label: 'GNAWING HUNGER — +1F +1A, CaC (POXWALKERS) (1PC)', description: 'Shamblerot Vectorium: In your Command phase, select one friendly POXWALKERS unit. Until the end of the turn, add 1 to the Attacks and Strength characteristics of melee weapons equipped by models in your unit (and add 1 to their Move characteristic).', factionId: 'DG', detachmentId: '000001053', combatType: 'melee', isStratagem: true, cpCost: 1, requiresAttackerKeyword: 'poxwalkers', effects: { attacksMod: 1, strengthMod: 1 } },
  { id: 'strat_new_dg_fresh_vectors', label: 'FRESH VECTORS — repetir heridas de 1 (CONTAGION ENGINE) (1PC)', description: 'Contagion Engines: When a friendly CONTAGION ENGINE unit is selected to attack in the Shooting or Fight phase, that unit’s attacks can re-roll Wound rolls of 1.', factionId: 'DG', detachmentId: '000001174', isStratagem: true, cpCost: 1, effects: { rerollWoundsOf1: true } },

  // ═══ GK — Nuevos Destacamentos ═══
  { id: 'strat_new_gk_truesilver_aegis', label: 'TRUESILVER AEGIS — FNP 4+ vs mortales (PALADIN SQUAD) (1PC)', description: 'Argent Assault: When a friendly PALADIN SQUAD unit suffers a mortal wound, that unit has the Feel No Pain 4+ ability against mortal wounds.', factionId: 'GK', detachmentId: '000001185', target: 'defender', isStratagem: true, cpCost: 1, requiresAttackerKeyword: 'paladin squad', effects: { feelNoPainThreshold: 4 } },
  { id: 'strat_new_gk_blades_from_the_beyond', label: 'BLADES FROM THE BEYOND — Lance, CaC (INTERCEPTOR SQUAD) (1PC)', description: 'Immaterial Interdiction: When a friendly INTERCEPTOR SQUAD unit that made a charge move this turn is selected to fight, until the end of the phase, that unit’s melee attacks have the [LANCE] ability.', factionId: 'GK', detachmentId: '000001187', combatType: 'melee', isStratagem: true, cpCost: 1, requiresAttackerKeyword: 'interceptor squad', effects: { woundMod: 1 } },

  // ═══ AC — Nuevos Destacamentos ═══
  {
    id: 'strat_new_ac_flawless_construction',
    label: 'FLAWLESS CONSTRUCTION — -1 herir recibido (WALKER) (1PC)',
    description: 'Might of the Moritoi: Until the end of the phase, each time an attack targets a friendly ADEPTUS CUSTODES WALKER unit, if the Strength characteristic of that attack is greater than the Toughness characteristic of your unit, subtract 1 from the Wound roll.',
    factionId: 'AC',
    detachmentId: '000001169',
    target: 'defender',
    requiresAttackerKeyword: 'walker',
    isStratagem: true,
    cpCost: 1,
    effects: { woundMod: -1 },
  },
  {
    id: 'strat_new_ac_deathsong_scythes',
    label: 'DEATHSONG SCYTHES — Lance (VIGILATORS, CaC) (1PC)',
    description: 'Silent Hunters: Until the end of the phase, melee attacks made by a friendly VIGILATORS unit have the [LANCE] ability.',
    factionId: 'AC',
    detachmentId: '000001101',
    combatType: 'melee',
    requiresAttackerKeyword: 'vigilators',
    isStratagem: true,
    cpCost: 1,
    effects: { woundMod: 1 },
  },
  {
    id: 'strat_new_ac_deathsong_scythes_2',
    label: 'DEATHSONG SCYTHES — +1A vs PSYKER (VIGILATORS, CaC) (1PC)',
    description: 'Silent Hunters: Until the end of the phase, melee attacks made by a friendly VIGILATORS unit that target a PSYKER unit have +1 to their Attacks characteristic.',
    factionId: 'AC',
    detachmentId: '000001101',
    combatType: 'melee',
    requiresAttackerKeyword: 'vigilators',
  ...
  {
    id: 'strat_new_ac_umbral_prosecution',
    label: 'UMBRAL PROSECUTION — +1 PA disparo (PROSECUTORS) (1PC)',
    description: 'Silent Hunters: Until the end of the phase, Boltgun weapons equipped by models in a friendly PROSECUTORS unit have the [RAPID FIRE 2] ability and +1 to their Armour Penetration characteristic.',
    factionId: 'AC',
    detachmentId: '000001101',
    combatType: 'ranged',
    requiresAttackerKeyword: 'prosecutors',
    isStratagem: true,
    cpCost: 1,
    effects: { apMod: 1 },
  },

  // ═══ AM — Nuevos Destacamentos ═══
  {
    id: 'strat_new_am_brutal_training',
    label: 'BRUTAL TRAINING — +1A +1F, CaC (MILITARUM TEMPESTUS) (1PC)',
    description: 'Tempestus Boarding Regiment: Until the end of the phase, add 1 to the Attacks and Strength characteristics of melee weapons equipped by models in a friendly MILITARUM TEMPESTUS unit that has not been selected to fight this phase.',
    factionId: 'AM',
    detachmentId: '000000928',
    combatType: 'melee',
    requiresAttackerKeyword: 'militarum tempestus',
    isStratagem: true,
    cpCost: 1,
    effects: { attacksMod: 1, strengthMod: 1 },
  },

  // ═══ LoV — Nuevos Destacamentos ═══
  {
    id: 'strat_new_lov_coordinated_crossfire',
    label: 'COORDINATED CROSSFIRE — repetir 1 impacto/1 herida, disparo (SAGITAUR) (1PC)',
    description: 'Armoured Trailblazers: Select one enemy unit. Until the end of the phase, ranged attacks made by up to two friendly SAGITAUR units that target that enemy unit can re-roll hit rolls of 1 and re-roll wound rolls of 1.',
    factionId: 'LoV',
    detachmentId: '000001160',
    combatType: 'ranged',
    requiresAttackerKeyword: 'sagitaur',
    isStratagem: true,
    cpCost: 1,
    effects: { rerollHitsOf1: true, rerollWoundsOf1: true },
  },
  {
    id: 'strat_new_lov_built_to_last',
    label: 'BUILT TO LAST — -1 herir recibido, disparo (SAGITAUR) (1PC)',
    description: 'Armoured Trailblazers: Until the end of the phase, each time a ranged attack targets a friendly SAGITAUR unit, if the Strength characteristic of that attack is greater than the Toughness characteristic of your unit, subtract 1 from the Wound roll.',
    factionId: 'LoV',
    detachmentId: '000001160',
    combatType: 'ranged',
    target: 'defender',
  ...
  // ═══ TYR — Nuevos Destacamentos ═══
  {
    id: 'strat_new_tyr_catalytic_biofortification',
    label: 'CATALYTIC BIOFORTIFICATION — FNP 4+ vs mortales (NORN ASSIMILATOR) (1PC)',
    description: 'Talons of the Norn Queen: Each time a friendly NORN ASSIMILATOR unit suffers a mortal wound, that unit has the Feel No Pain 4+ ability against mortal wounds.',
    factionId: 'TYR',
    detachmentId: '000001176',
    target: 'defender',
    requiresAttackerKeyword: 'norn assimilator',
    isStratagem: true,
    cpCost: 1,
    effects: { feelNoPainThreshold: 4 },
  },
  {
    id: 'strat_new_tyr_lesser_prey',
    label: 'LESSER PREY — +2 Fuerza, CaC (NORN ASSIMILATOR) (1PC)',
    description: 'Talons of the Norn Queen: Until the end of the phase, melee attacks made by a friendly NORN ASSIMILATOR or NORN EMISSARY unit have +2 to their Strength characteristic.',
    factionId: 'TYR',
    detachmentId: '000001176',
    combatType: 'melee',
    requiresAttackerKeyword: 'norn assimilator',
  ...
  {
    id: 'strat_new_tyr_lesser_prey_2',
    label: 'LESSER PREY — +2 Fuerza, CaC (NORN EMISSARY) (1PC)',
    description: 'Talons of the Norn Queen: Until the end of the phase, melee attacks made by a friendly NORN ASSIMILATOR or NORN EMISSARY unit have +2 to their Strength characteristic.',
    factionId: 'TYR',
    detachmentId: '000001176',
    combatType: 'melee',
    requiresAttackerKeyword: 'norn emissary',
    isStratagem: true,
    cpCost: 1,
    effects: { strengthMod: 2 },
  },

  // ═══ WE — Nuevos Destacamentos ═══
  {
    id: 'strat_new_we_focused_ferocity',
    label: 'FOCUSED FEROCITY — +1A, CaC (TERMINATOR SQUAD) (1PC)',
    description: 'Butchers of Khorne: Until the end of the phase, melee attacks made by a friendly TERMINATOR SQUAD unit have +1 to their Attacks characteristic.',
    factionId: 'WE',
    detachmentId: '000001159',
    combatType: 'melee',
    requiresAttackerKeyword: 'terminator squad',
    isStratagem: true,
    cpCost: 1,
    effects: { attacksMod: 1 },
  },
  {
    id: 'strat_new_we_trophy_for_the_throne',
    label: 'A TROPHY FOR THE THRONE — +1 herir, CaC (TERMINATOR SQUAD) (1PC)',
    description: 'Butchers of Khorne: Until the end of the phase, melee attacks made by a friendly TERMINATOR SQUAD unit that target a MONSTER or VEHICLE unit have +1 to their Wound roll.',
    factionId: 'WE',
    detachmentId: '000001159',
    combatType: 'melee',
    requiresAttackerKeyword: 'terminator squad',
  ...
  {
    id: 'strat_new_we_wrath_beyond_reason',
    label: 'WRATH BEYOND REASON — -1 daño recibido, disparo (TERMINATOR SQUAD) (2PC)',
    description: 'Butchers of Khorne: Until the attacking enemy unit has finished making its attacks, ranged attacks that target a friendly TERMINATOR SQUAD unit have -1 to their Damage characteristic.',
    factionId: 'WE',
    detachmentId: '000001159',
    combatType: 'ranged',
    target: 'defender',
  ...
  // ═══ NEC — Nuevos Destacamentos ═══
  {
    id: 'strat_new_nec_subsurface_quantumweave',
    label: 'SUBSURFACE QUANTUMWEAVE — -1 PA recibido (TITANIC FLY) (1PC)',
    description: 'The Phaeron’s Armoury: Until the attacking enemy unit has finished making its attacks, attacks that target a friendly NECRONS TITANIC FLY unit have -1 to their Armour Penetration characteristic.',
    factionId: 'NEC',
    detachmentId: '000001173',
    target: 'defender',
    requiresAttackerKeyword: 'titanic',
    isStratagem: true,
    cpCost: 1,
    effects: { apMod: -1 },
  },
  {
    id: 'strat_new_nec_cosmic_storm',
    label: 'COSMIC STORM — +1 PA disparo (OBELISK) (1PC)',
    description: 'The Phaeron’s Armoury: Until the end of the phase, Tesla Sphere weapons equipped by a friendly OBELISK or TESSERACT VAULT unit have +1 to their Armour Penetration characteristic.',
    factionId: 'NEC',
    detachmentId: '000001173',
    combatType: 'ranged',
    requiresAttackerKeyword: 'obelisk',
    isStratagem: true,
    cpCost: 1,
    effects: { apMod: 1 },
  },
  {
    id: 'strat_new_nec_cosmic_storm_2',
    label: 'COSMIC STORM — +1 PA disparo (TESSERACT VAULT) (1PC)',
    description: 'The Phaeron’s Armoury: Until the end of the phase, Tesla Sphere weapons equipped by a friendly OBELISK or TESSERACT VAULT unit have +1 to their Armour Penetration characteristic.',
    factionId: 'NEC',
    detachmentId: '000001173',
    combatType: 'ranged',
    requiresAttackerKeyword: 'tesseract vault',
    isStratagem: true,
    cpCost: 1,
    effects: { apMod: 1 },
  },
  ...
  // ═══ Enhancements ═══
  // Primer lote de Mejoras claramente modelables como CombatModifiers — no es una traducción
  // exhaustiva de Enhancements.csv (ahí hay ~1050 entradas, muchas "once per game"/posicionales,
  // no modelables como toggle continuo). Se añaden de forma incremental, mismo criterio que el
  // resto de este archivo: si el efecto es demasiado específico o no afecta al combate, se omite.
  {
    id: 'enh_ac_gift_of_terran_artifice',
    label: 'Mejora: Gift of Terran Artifice — +1 herir CaC',
    description: 'ADEPTUS CUSTODES model only. Each time the bearer makes a melee attack, add 1 to the Wound roll.',
    factionId: 'AC',
    enhancementId: '000008921004',
    combatType: 'melee',
    effects: { woundMod: 1 },
  },
  {
    id: 'enh_ac_oblivion_knight',
    label: 'Mejora: Oblivion Knight — +1 impactar (aura de liderazgo)',
  ...
  { id: 'enh_ac_oblivion_knight_2', label: 'Mejora: Oblivion Knight — +1 herir (objetivo es PSYKER)', factionId: 'AC', enhancementId: '000008926004', effects: { woundMod: 1 } },
  {
    ...
    factionId: 'AE',
    enhancementId: '000009903003',
    target: 'defender',
    effects: { hitMod: -1 },
  },
  {
    id: 'enh_aoi_ignis_judicium',
    label: 'Mejora: Ignis Judicium — Devastating Wounds a distancia',
    description: 'INQUISITOR or MINISTORUM PRIEST model only. The bearer’s ranged weapons have the [DEVASTATING WOUNDS], [MELTA 1] and [PRECISION] abilities.',
    factionId: 'AoI',
    enhancementId: '000009130002',
    combatType: 'ranged',
    effects: { devastatingWoundsBonus: true },
  },
  {
    id: 'enh_cd_fulgurating_presence',
    label: 'Mejora: Fulgurating Presence — −1 impactar recibido',
    description: 'Each time an attack targets the bearer, subtract 1 from the Hit roll.',
    factionId: 'CD',
    enhancementId: '000009580002',
    target: 'defender',
    effects: { hitMod: -1 },
  },
  {
    id: 'enh_cd_false_majesty',
    label: 'Mejora: False Majesty (Aura) — +1 herir CaC',
    ...
    factionId: 'CD',
    enhancementId: '000009806002',
    combatType: 'melee',
    effects: { woundMod: 1 },
  },
  {
    id: 'enh_cd_dreaming_crown',
    label: 'Mejora: Dreaming Crown (Aura) — +1 impactar CaC',
    ...
    factionId: 'CD',
    enhancementId: '000009806003',
    combatType: 'melee',
    effects: { hitMod: 1 },
  },
  {
    id: 'enh_cd_neverblade',
    label: 'Mejora: Neverblade — +2S/+1A/+1PA/+1 impactar CaC',
    ...
    factionId: 'CD',
    enhancementId: '000009810004',
    combatType: 'melee',
    effects: { strengthMod: 2, attacksMod: 1, apMod: 1, hitMod: 1 },
  },
  {
    id: 'enh_dg_foul_constitution',
    label: 'Mejora: Foul Constitution — −1 Daño recibido',
    description: 'Each time an attack is allocated to the bearer, subtract 1 from the Damage characteristic of that attack.',
    factionId: 'DG',
    enhancementId: '000009398002',
    target: 'defender',
    effects: { damageReduction: 1 },
  },
  {
    id: 'enh_dg_furnace_of_plagues',
    label: 'Mejora: Furnace of Plagues — +1S/+1A CaC y Devastating Wounds',
    description: 'DEATH GUARD model only. Add 1 to the Strength and Attacks characteristics of the bearer’s melee weapons, and the bearer’s melee weapons have the [DEVASTATING WOUNDS] ability.',
    factionId: 'DG',
    enhancementId: '000010123003',
    combatType: 'melee',
    effects: { strengthMod: 1, attacksMod: 1, devastatingWoundsBonus: true },
  },
